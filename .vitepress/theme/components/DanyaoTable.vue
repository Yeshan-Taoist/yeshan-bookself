    ...
    <table>
      ...
      <tbody>
        ...
        <tr v-if="filteredList.length === 0">
          <td colspan="7" class="empty-row">暂无对应丹药</td>
        </tr>
      </tbody>
    </table>
  </div>
...
import { danyaoData, categories, grades } from '../../../data/danyao'

const currentCategory = ref('all')
const currentGrade = ref('all')

const filteredList = computed(() => {
  return danyaoData.filter(item => {
