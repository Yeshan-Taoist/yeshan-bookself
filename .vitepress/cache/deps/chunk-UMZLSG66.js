// node_modules/vitepress-plugin-legend/dist/defaultLocale-D7EN2tov-CK6dgF7Y.js
function J(t) {
...
function _(t) {
  ...
  function C(a) {
    ...
    c === "n" ? (j = true, c = "g") : T[c] || (g === void 0 && (g = 12), F = true, c = "g"), (v || M === "0" && b === "=") && (v = true, M = "0", b = "=");
    ...
    function X(e) {
      ...
      if (c === "c")
        ...
        e = +e;
        var S = e < 0 || 1 / e < 0;
        if (e = isNaN(e) ? y : L(Math.abs(e), g), F && (e = V(e)), S && +e == 0 && h !== "+" && (S = false), m = (S ? h === "(" ? h : u : h === "-" || h === "(" ? "" : h) + m, l = (c === "s" ? Z[8 + q / 3] : "") + l + (S && h === "(" ? ")" : ""), I) {
...
//# sourceMappingURL=chunk-UMZLSG66.js.map
