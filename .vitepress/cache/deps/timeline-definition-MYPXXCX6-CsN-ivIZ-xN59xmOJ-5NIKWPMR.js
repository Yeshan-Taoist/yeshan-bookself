...
// node_modules/vitepress-plugin-legend/dist/timeline-definition-MYPXXCX6-CsN-ivIZ-xN59xmOJ.js
var U = (function() {
  var n = F(function(g, i, c, d) {
    ...
    performAction: F(function(g, i, c, d, u, o, m) {
      var k = o.length - 1;
      switch (u) {
        case 1:
          return o[k - 1];
    ...
    parse: F(function(g) {
      var i = this, c = [0], d = [], u = [null], o = [], m = this.table, k = "", N = 0, P = 0, D = 2, C = 1, w = o.slice.call(arguments, 1), x = Object.create(this.lexer), S = { yy: {} };
      for (var H in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, H) && (S.yy[H] = this.yy[H]);
      ...
      function J() {
        var E;
        return E = d.pop() || x.lex() || C, typeof E != "number" && (E instanceof Array && (d = E, E = d.pop()), E = i.symbols_[E] || E), E;
      }
      F(J, "lex");
      for (var v, A, T, Z, O = {}, F2, I, K, W; ; ) {
        if (A = c[c.length - 1], this.defaultActions[A] ? T = this.defaultActions[A] : ((v === null || typeof v > "u") && (v = J()), T = m[A] && m[A][v]), typeof T > "u" || !T.length || !T[0]) {
          ...
          W = [];
          for (F2 in m[A])
            this.terminals_[F2] && F2 > D && W.push("'" + this.terminals_[F2] + "'");
          x.showPosition ? q = "Parse error on line " + (N + 1) + `:
` + x.showPosition() + `
Expecting ` + W.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : q = "Parse error on line " + (N + 1) + ": Unexpected " + (v == C ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(q, {
            text: x.match,
        ...
        switch (T[0]) {
          case 1:
            c.push(v), u.push(x.yytext), o.push(x.yylloc), c.push(T[1]), v = null, P = x.yyleng, k = x.yytext, N = x.yylineno, L = x.yylloc;
            break;
          case 2:
            if (I = this.productions_[T[1]][1], O.$ = u[u.length - I], O._$ = {
              first_line: o[o.length - (I || 1)].first_line,
              last_line: o[o.length - 1].last_line,
              first_column: o[o.length - (I || 1)].first_column,
              last_column: o[o.length - 1].last_column
            }, G && (O._$.range = [
              o[o.length - (I || 1)].range[0],
              ...
              return Z;
            I && (c = c.slice(0, -1 * I * 2), u = u.slice(0, -1 * I), o = o.slice(0, -1 * I)), c.push(this.productions_[T[1]][0]), u.push(O.$), o.push(O._$), K = m[c[c.length - 2]][c[c.length - 1]], c.push(K);
            break;
          case 3:
            return true;
        }
...
` + this.showPosition(), {
      ...
      performAction: F(function(i, c, d, u) {
        switch (d) {
          case 0:
            break;
          case 1:
  ...
  return F(b, "Parser"), b.prototype = f, f.Parser = b, new b();
})();
U.parser = U;
var St = U;
var it = {};
...
var B = [];
var z = [];
var at = F(() => dW, "getCommonDb");
var ot = F(function() {
  Y.length = 0, B.length = 0, j = "", z.length = 0, Q2t();
}, "clear");
var ct = F(function(n) {
  j = n, Y.push(n);
}, "addSection");
...
var Nt = F(function(n, t) {
  ...
  return F(h, "ambivalent"), t.score > 3 ? s(a) : t.score < 3 ? l(a) : h(a), e;
}, "drawFace");
var Ct = F(function(n, t) {
...
var gt = (function() {
  ...
  function t(s, l, h, y, p, f, _, b, g) {
    ...
    for (let u = 0; u < d.length; u++) {
      ...
      m.append("tspan").attr("x", h + p / 2).attr("dy", o).text(d[u]), m.attr("y", y + f / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), a(m, _);
    }
  }
  F(t, "byTspan");
  function e(s, l, h, y, p, f, _, b) {
    ...
    i.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(s), t(s, g, h, y, p, f, _, b), a(i, _);
  }
  F(e, "byFo");
  function a(s, l) {
    for (const h in l)
  ...
  return F(a, "_setTextAttrs"), function(s) {
...
function Q(n, t) {
  n.each(function() {
    var e = gn(this), a = e.text().split(/(\s+|<br>)/).reverse(), s, l = [], h = 1.1, y = e.attr("y"), p = parseFloat(e.attr("dy")), f = e.text(null).append("tspan").attr("x", 0).attr("y", y).attr("dy", p + "em");
    for (let _ = 0; _ < a.length; _++)
      s = a[a.length - 1 - _], l.push(s), f.text(l.join(" ").trim()), (f.node().getComputedTextLength() > t || s === "<br>") && (l.pop(), f.text(l.join(" ").trim()), s === "<br>" ? l = [""] : l = [s], f = e.append("tspan").attr("x", 0).attr("y", y).attr("dy", h + "em").text(s));
  });
}
F(Q, "wrap");
var Ot = F(function(n, t, e, a) {
  const s = e % Tt2 - 1, l = n.append("g");
  t.section = s, l.attr(
    "class",
    (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + s)
  );
  const h = l.append("g"), y = l.append("g"), p = y.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(Q, t.width).node().getBBox(), f = a.fontSize?.replace ? a.fontSize.replace("px", "") : a.fontSize;
...
var jt = F(function(n, t, e) {
  const a = n.append("g"), s = a.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(Q, t.width).node().getBBox(), l = e.fontSize?.replace ? e.fontSize.replace("px", "") : e.fontSize;
  return a.remove(), s.height + l * 1.1 * 0.5 + t.padding;
}, "getVirtualNodeHeight");
var zt = F(function(n, t, e) {
...
var Dt = F(function(n, t, e, a) {
  const s = _n(), l = s.timeline?.leftMargin ?? 50;
  Tt.debug("timeline", a.db);
  const h = s.securityLevel;
  let y;
  h === "sandbox" && (y = gn("#i" + t));
  const p = (h === "sandbox" ? gn(y.nodes()[0].contentDocument.body) : gn("body")).select("#" + t);
  p.append("g");
  const f = a.db.getTasks(), _ = a.db.getCommonDb().getDiagramTitle();
  Tt.debug("task", f), M.initGraphics(p);
  ...
  b.forEach(function(C) {
    ...
    Tt.debug("sectionHeight before draw", x), g = Math.max(g, x + 20);
  });
  let N = 0, P = 0;
  Tt.debug("tasks.length", f.length);
  for (const [C, w] of f.entries()) {
    ...
    Tt.debug("taskHeight before draw", S), i = Math.max(i, S + 20), N = Math.max(N, w.events.length);
    let H = 0;
    for (const L of w.events) {
      ...
      H += M.getVirtualNodeHeight(p, G, s);
    }
    w.events.length > 0 && (H += (w.events.length - 1) * 10), P = Math.max(P, H);
  }
  Tt.debug("maxSectionHeight before draw", g), Tt.debug("maxTaskHeight before draw", i), b && b.length > 0 ? b.forEach((C) => {
    const w = f.filter((L) => L.section === C), x = {
      number: m,
      descr: C,
      section: m,
    ...
    Tt.debug("sectionNode", x);
    const S = p.append("g"), H = M.drawNode(S, x, m, s);
    Tt.debug("sectionNode output", H), S.attr("transform", `translate(${u}, ${d})`), o += g + 50, w.length > 0 && st(
      p,
      w,
      m,
      u,
  ...
  Tt.debug("bounds", D), _ && p.append("text").text(_).attr("x", D.width / 2 - l).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), c = k ? g + i + 150 : i + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", l).attr("y1", c).attr("x2", D.width + 3 * l).attr("y2", c).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), X2t(
    void 0,
    p,
    s.timeline?.padding ?? 50,
    s.timeline?.useMaxWidth ?? false
  );
}, "draw");
var st = F(function(n, t, e, a, s, l, h, y, p, f, _) {
  for (const b of t) {
    const g = {
      descr: b.task,
      section: e,
    ...
    if (Tt.debug("taskHeight after draw", c), i.attr("transform", `translate(${a}, ${s})`), l = Math.max(l, c), b.events) {
    ...
    a = a + 200, _ && !h.timeline?.disableMulticolor && e++;
  }
  s = s - 10;
}, "drawTasks");
var Ft = F(function(n, t, e, a, s, l) {
  let h = 0;
  const y = s;
  s = s + 100;
  for (const p of t) {
    ...
    Tt.debug("eventNode", f);
    const _ = n.append("g").attr("class", "eventWrapper"), b = M.drawNode(_, f, e, l).height;
    h = h + b, _.attr("transform", `translate(${a}, ${s})`), s = s + 10 + b;
  }
  return s = y, h;
}, "drawEvents");
var Wt = {
...
var Rt = F((n) => {
  ...
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++)
    n["lineColor" + e] = n["lineColor" + e] || n["cScaleInv" + e], uf(n["lineColor" + e]) ? n["lineColor" + e] = fe(n["lineColor" + e], 20) : n["lineColor" + e] = _e(n["lineColor" + e], 20);
  for (let e = 0; e < n.THEME_COLOR_LIMIT; e++) {
    const a = "" + (17 - 3 * e);
    t += `
...
//# sourceMappingURL=timeline-definition-MYPXXCX6-CsN-ivIZ-xN59xmOJ-5NIKWPMR.js.map
