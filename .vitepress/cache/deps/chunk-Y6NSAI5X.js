...
// node_modules/vitepress-plugin-legend/dist/linear-m73w_WNc-DL6hJSaB.js
function g(t, n) {
...
function x(t) {
  let n, u, e;
  t.length !== 2 ? (n = g, u = (i, c) => g(t(i), c), e = (i, c) => t(i) - c) : (n = t === g || t === B ? t : I, u = t, e = t);
...
var E2 = Math.sqrt(2);
function p(t, n, u) {
  const e = (n - t) / Math.max(0, u), a2 = Math.floor(Math.log10(e)), f = e / Math.pow(10, a2), o = f >= T ? 10 : f >= C ? 5 : f >= E2 ? 2 : 1;
  let i, c, r;
...
function w(t, n) {
  var u = typeof n, e;
  return n == null || u === "boolean" ? Y$(n) : (u === "number" ? Pa : u === "string" ? (e = Ad(n)) ? (n = e, QA) : x3t : n instanceof Ad ? QA : n instanceof Date ? S : L(n) ? H : Array.isArray(n) ? Q : typeof n.valueOf != "function" && typeof n.toString != "function" || isNaN(n) ? U : Pa)(t, n);
}
function W(t, n) {
...
function rt() {
  ...
  return l.invert = function(s) {
    return o(a2((r || (r = i(n, t.map(e), Pa)))(s)));
  }, l.domain = function(s) {
...
function ot(t) {
  ...
  return t.ticks = function(u) {
    var e = n();
    return F(e[0], e[e.length - 1], u ?? 10);
...
//# sourceMappingURL=chunk-Y6NSAI5X.js.map
