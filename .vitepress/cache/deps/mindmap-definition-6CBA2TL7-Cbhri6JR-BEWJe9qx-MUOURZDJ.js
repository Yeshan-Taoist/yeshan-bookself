...
// node_modules/vitepress-plugin-legend/dist/mindmap-definition-6CBA2TL7-Cbhri6JR-BEWJe9qx.js
var it = { exports: {} };
var rt = { exports: {} };
var nt = { exports: {} };
var Ot = nt.exports;
        ...
        (function(p) {
          ...
          function(p, T, f) {
            ...
            t.calcSeparationAmount = function(e, r, h, a) {
              ...
              var d = e.getX(), c = e.getY(), E = e.getRight(), m = e.getX(), _ = e.getBottom(), N = e.getRight(), D = e.getWidthHalf(), g = e.getHeightHalf(), L = r.getX(), n = r.getY(), u = r.getRight(), l = r.getX(), v = r.getBottom(), A = r.getRight(), I = r.getWidthHalf(), w = r.getHeightHalf(), R = false, S = false;
              if (a === y) {
                if (s > o)
                ...
                var U = e.height / e.width, G = r.height / r.width, C = (o - s) / (y - a), x = void 0, F2 = void 0, k = void 0, Y = void 0, X = void 0, P = void 0;
                if (-U === C ? a > y ? (h[0] = m, h[1] = _, R = true) : (h[0] = E, h[1] = c, R = true) : U === C && (a > y ? (h[0] = d, h[1] = c, R = true) : (h[0] = N, h[1] = _, R = true)), -G === C ? y > a ? (h[2] = l, h[3] = v, S = true) : (h[2] = u, h[3] = n, S = true) : G === C && (y > a ? (h[2] = L, h[3] = n, S = true) : (h[2] = A, h[3] = v, S = true)), R && S)
                  return false;
                if (a > y ? s > o ? (x = this.getCardinalDirection(U, C, 4), F2 = this.getCardinalDirection(G, C, 2)) : (x = this.getCardinalDirection(-U, C, 3), F2 = this.getCardinalDirection(-G, C, 1)) : s > o ? (x = this.getCardinalDirection(-U, C, 1), F2 = this.getCardinalDirection(-G, C, 3)) : (x = this.getCardinalDirection(U, C, 2), F2 = this.getCardinalDirection(G, C, 4)), !R)
                  switch (x) {
                    case 1:
          ...
          function(p, T, f) {
            ...
            var e = function(s) {
              ...
              function s(y) {
                var o = this;
                t(this, s), this.length = 0, this.head = null, this.tail = null, y?.forEach(function(d) {
                  return o.push(d);
                });
              }
              return i(s, [{
          ...
          function(T, f, i) {
            ...
            g.prototype.newGraphManager = function() {
              ...
              for (var u = new d(0, 0), l = Math.ceil(Math.sqrt(n.length)), v = 0, A = 0, I = 0, w = new c(0, 0), R = 0; R < n.length; R++) {
                ...
                var S = n[R], U = E.findCenterOfTree(S);
                u.x = I, u.y = A, w = g.radialLayout(S, U, u), w.y > v && (v = Math.floor(w.y)), I = Math.floor(w.x + s.DEFAULT_COMPONENT_SEPERATION);
              }
              ...
              return I.inverseTransformPoint(S);
            }, g.branchRadialLayout = function(n, u, l, v, A, I) {
              var w = (v - l + 1) / 2;
              w < 0 && (w += 180);
              var R = (w + l) % 360, S = R * _.TWO_PI / 360, U = A * Math.cos(S), G = A * Math.sin(S);
              n.setCenter(U, G);
              var C = [];
              C = C.concat(n.getEdges());
              var x = C.length;
              u != null && x--;
              for (var F2 = 0, k = C.length, Y, X = n.getEdgesBetween(u); X.length > 1; ) {
                var P = X[0];
                X.splice(0, 1);
                var B = C.indexOf(P);
              ...
              for (var $ = Math.abs(v - l) / x, H = Y; F2 != x; H = ++H % k) {
                var V = C[H].getOtherEnd(n);
                if (V != u) {
                  var z = (l + F2 * $) % 360, j = (z + $) % 360;
                  g.branchRadialLayout(V, n, z, j, A + I, I), F2++;
                }
              }
              ...
              Object.keys(u).forEach(function(S) {
                if (u[S].length > 1) {
                  ...
                  var G = u[S][0].getParent(), C = new h(n.graphManager);
                  ...
                  var x = n.getGraphManager().add(n.newGraph(), C), F2 = G.getChild();
                  F2.add(C);
              ...
              for (var I = u, w = 0; w < n.rows.length; w++) {
                ...
                for (var S = 0, U = 0; U < R.length; U++) {
                  var G = R[U];
                  G.rect.x = u, G.rect.y = l, u += G.rect.width + n.horizontalPadding, G.rect.height > S && (S = G.rect.height);
                }
              ...
              n.sort(function(R, S) {
                return R.rect.width * R.rect.height > S.rect.width * S.rect.height ? -1 : R.rect.width * R.rect.height < S.rect.width * S.rect.height ? 1 : 0;
              });
              ...
              var S = 0;
              R > n.rowHeight[l] && (S = n.rowHeight[l], n.rowHeight[l] = R, S = n.rowHeight[l] - S), n.height += S, n.rows[l].push(u);
              ...
              var A = l.startX, I = l.finishX, w = l.startY, R = l.finishY, S = 0, U = 0, G = 0, C = 0, x = [S, G, U, C];
              if (w > 0)
                for (var F2 = A; F2 <= I; F2++)
                  x[0] += this.grid[F2][w - 1].length + this.grid[F2][w].length - 1;
              if (I < this.grid.length - 1)
                for (var F2 = w; F2 <= R; F2++)
                  x[1] += this.grid[I + 1][F2].length + this.grid[I][F2].length - 1;
        ...
        (function(T) {
          ...
          function(T, f, i) {
            ...
            c.prototype.run = function() {
              ...
              var S = function(G, C) {
                typeof G == "number" && (G = C);
                var x = G.data("id"), F2 = L.idToLNode[x];
                return {
                  x: F2.getRect().getCenterX(),
                  y: F2.getRect().getCenterY()
                };
              }, U = function G() {
                for (var C = function() {
                  D.fit && D.cy.fit(D.eles, D.padding), _ || (_ = true, L.cy.one("layoutready", D.ready), L.cy.trigger({ type: "layoutready", layout: L }));
                }, x = L.options.refresh, F2, k = 0; k < x && !F2; k++)
                  F2 = L.stopped || L.layout.tick();
                if (F2) {
                  g.checkLayoutSuccess() && !g.isSubLayout && g.doPostLayout(), g.tilingPostLayout && g.tilingPostLayout(), g.isLayoutFinished = true, L.options.eles.nodes().positions(S), C(), L.cy.one("layoutstop", L.options.stop), L.cy.trigger({ type: "layoutstop", layout: L }), N && cancelAnimationFrame(N), _ = false;
                  return;
                }
              ...
              }), g.runLayout(), this.options.animate !== "during" && (L.options.eles.nodes().not(":parent").layoutPositions(L, L.options, S), _ = false), this;
...
var ot = (function() {
  var O = F(function(D, g, L, n) {
    ...
    performAction: F(function(D, g, L, n, u, l, v) {
      var A = l.length - 1;
      switch (u) {
        case 6:
        case 7:
    ...
    parse: F(function(D) {
      var g = this, L = [0], n = [], u = [null], l = [], v = this.table, A = "", I = 0, w = 0, R = 2, S = 1, U = l.slice.call(arguments, 1), G = Object.create(this.lexer), C = { yy: {} };
      ...
      function X() {
        var W;
        return W = n.pop() || G.lex() || S, typeof W != "number" && (W instanceof Array && (n = W, W = n.pop()), W = g.symbols_[W] || W), W;
      }
      F(X, "lex");
...
` + G.showPosition() + `
Expecting ` + Z.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : J = "Parse error on line " + (I + 1) + ": Unexpected " + (P == S ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(J, {
            text: G.match,
        ...
        switch ($[0]) {
          case 1:
            L.push(P), u.push(G.yytext), l.push(G.yylloc), L.push($[1]), P = null, w = G.yyleng, A = G.yytext, I = G.yylineno, F2 = G.yylloc;
            break;
          case 2:
...
` + this.showPosition(), {
      ...
      performAction: F(function(g, L, n, u) {
        switch (n) {
          case 0:
  ...
  return F(N, "Parser"), N.prototype = m, m.Parser = N, new N();
})();
ot.parser = ot;
var Gt = ot;
var bt = {
...
var Ft = (tt = class {
  ...
  addNode(O, M, p, T) {
    Tt.info("addNode", O, M, p, T);
    const f = _n();
    let i = f.mindmap?.padding ?? eW.mindmap.padding;
    switch (T) {
    ...
    const t = {
      ...
      type: T,
      children: [],
      width: f.mindmap?.maxNodeWidth ?? eW.mindmap.maxNodeWidth,
      padding: i
    }, e = this.getParent(O);
    if (e)
  ...
  getType(O, M) {
    switch (Tt.debug("In get type", O, M), O) {
      case "[":
  ...
  decorateNode(O) {
    if (!O)
      return;
    const M = _n(), p = this.nodes[this.nodes.length - 1];
    O.icon && (p.icon = sc(O.icon, M)), O.class && (p.class = sc(O.class, M));
  }
  type2Str(O) {
    switch (O) {
...
F(dt, "insertPolygonShape");
var $t = F(function(O, M, p) {
...
var Wt = F(async function(O, M, p, T, f) {
...
`);
  ...
  const y = a.node().getBBox(), [o] = jy(f.fontSize);
...
function pt(O, M) {
  M.edges().map((p, T) => {
    ...
    if (p[0]._private.bodyBounds) {
      ...
      Tt.trace("Edge: ", T, f), O.insert("path").attr(
        "d",
...
function ft(O, M) {
  return new Promise((p) => {
    const T = gn("body").append("div").attr("id", "cy").attr("style", "display:none"), f = Jn({
...
function yt(O, M) {
  M.nodes().map((p, T) => {
    ...
    Tt.info("id:", T, "Position: (", p.position().x, ", ", p.position().y, ")", f), i.attr(
      "transform",
...
` + O);
  ...
  pt(r, a), yt(f, a), X2t(
    void 0,
    e,
    t.mindmap?.padding ?? eW.mindmap.padding,
    t.mindmap?.useMaxWidth ?? eW.mindmap.useMaxWidth
  );
}, "draw");
var zt = {
  draw: Vt
...
var qt = F((O) => {
  ...
  for (let p = 0; p < O.THEME_COLOR_LIMIT; p++)
    O["lineColor" + p] = O["lineColor" + p] || O["cScaleInv" + p], uf(O["lineColor" + p]) ? O["lineColor" + p] = fe(O["lineColor" + p], 20) : O["lineColor" + p] = _e(O["lineColor" + p], 20);
  for (let p = 0; p < O.THEME_COLOR_LIMIT; p++) {
    const T = "" + (17 - 3 * p);
    M += `
...
//# sourceMappingURL=mindmap-definition-6CBA2TL7-Cbhri6JR-BEWJe9qx-MUOURZDJ.js.map
