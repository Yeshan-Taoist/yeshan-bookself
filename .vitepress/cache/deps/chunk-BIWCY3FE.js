...
// node_modules/vitepress-plugin-legend/dist/layout-FfY8zw-4-BpZLjTMh.js
function Qn(n) {
  return w6t(p6t(n, void 0, er), n + "");
}
var Un = 1;
var Xn = 4;
function Wn(n) {
...
function y2(n) {
  return n && n.length ? ar(n, iG, er2) : void 0;
}
function Z(n, r) {
...
function or(n, r) {
  if (n !== r) {
    var e = n !== void 0, t = n === null, o = n === n, i = P(n), a = r !== void 0, u = r === null, d = r === r, c = P(r);
...
function ar2(n, r, e) {
  r.length ? r = br(r, function(i) {
    return tm(i) ? function(a) {
      return hr(a, i.length === 1 ? i[0] : i);
    } : i;
  }) : r = [iG];
  var t = -1;
  r = br(r, Ywt(Er));
  var o = E(n, function(i, a, u) {
...
function fr2(n) {
  return function(r, e, t) {
    return t && typeof t != "number" && $6t(r, e, t) && (e = t = void 0), r = R(r), e === void 0 ? (e = r, r = 0) : e = R(e), t = t === void 0 ? r < e ? 1 : -1 : R(t), sr2(r, e, t);
  };
}
var E2 = fr2();
var R2 = k6t(function(n, r) {
  if (n == null)
    return [];
  var e = r.length;
  return e > 1 && $6t(n, r[0], r[1]) ? r = [] : e > 2 && $6t(r[0], r[1], r[2]) && (r = [r[0]]), ar2(n, wa(r), []);
});
var hr2 = 0;
function H(n) {
  var r = ++hr2;
...
function mr(n, r) {
  if (n.nodeCount() <= 1)
    return [];
  var e = yr(n, r || wr), t = br2(e.graph, e.buckets, e.zeroIdx);
  return er(
    lr(t, function(o) {
...
function kr(n) {
  ...
  _a(r, function(t) {
    var o = n.edge(t);
    n.removeEdge(t), o.forwardName = t.name, o.reversed = true, n.setEdge(t.w, t.v, o, H("rev"));
  });
  function e(t) {
    return function(o) {
...
function Tr(n) {
  _a(n.nodes(), function(r) {
    ...
    var e = n.edge(r);
    _a(e.points, V), Object.prototype.hasOwnProperty.call(e, "y") && V(e);
  });
}
function V(n) {
  n.y = -n.y;
...
function kn(n) {
  ...
  r.setNode(e, {});
  for (var o, i; Br(r, n) < t; )
    o = Fr(r, n), i = r.hasNode(o.v) ? P2(n, o) : -P2(n, o), Vr(r, n, i);
  return r;
}
function Br(n, r) {
  function e(t) {
    _a(r.nodeEdges(t), function(o) {
      ...
      !n.hasNode(a) && !P2(r, o) && (n.setNode(a, {}), n.setEdge(t, a, {}), e(a));
    });
  }
  return _a(n.nodes(), e), n.nodeCount();
}
function Fr(n, r) {
  return Z(r.edges(), function(e) {
...
function Pn(n, r, e, t) {
  var o = e.v, i = e.w;
  n.removeEdge(o, i), n.setEdge(t.v, t.w, {}), X(n), U(n, r), zr(n, r);
}
function zr(n, r) {
...
function Zr(n) {
  var r = O(n, "root", {}, "_root"), e = Hr(n), t = y2(ma(e)) - 1, o = 2 * t + 1;
...
function he(n) {
  var r = bn(n), e = sn(n, E2(1, r + 1), "inEdges"), t = sn(n, E2(r - 1, -1, -1), "outEdges"), o = te(n);
  fn(n, o);
    ...
    return _a(i, function(f, h) {
      ...
      (g || f === c) && (_a(i.slice(u, h + 1), function(l) {
        _a(n.predecessors(l), function(w) {
          var _ = n.node(w), W = _.order;
          (W < a || v < W) && !(_.dummy && n.node(l).dummy) && Mn(e, w, l);
        });
      }), u = h + 1, a = v);
    }), i;
  }
...
function Oe(n, r) {
  var e = ma(r), t = sr(e), o = y2(e);
  _a(["u", "d"], function(i) {
    _a(["l", "r"], function(a) {
      var u = i + a, d = n[u], c;
      if (d !== r) {
        var f = ma(d);
        c = a === "l" ? t - sr(f) : o - y2(f), c && (n[u] = C(d, function(h) {
          return h + c;
        }));
      }
    });
...
function Ie(n) {
  var r = S(n), e = _6t(we(n, r), me(n, r)), t = {}, o;
  _a(["u", "d"], function(a) {
...
function Re(n) {
  n = mn(n), Me(n), rr(Ie(n), function(r, e) {
    n.node(e).x = r;
  });
}
function Me(n) {
...
function Te(n, r) {
  r("    makeSpaceForEdgeLabels", () => ze(n)), r("    removeSelfEdges", () => Xe(n)), r("    acyclic", () => kr(n)), r("    nestingGraph.run", () => Zr(n)), r("    rank", () => Dr(mn(n))), r("    injectEdgeLabelProxies", () => Ae(n)), r("    removeEmptyRanks", () => _r(n)), r("    nestingGraph.cleanup", () => Ur(n)), r("    normalizeRanks", () => Or(n)), r("    assignRankMinMax", () => De(n)), r("    removeEdgeLabelProxies", () => Je(n)), r("    normalize.run", () => Cr(n)), r("    parentDummyChains", () => ve(n)), r("    addBorderSegments", () => Lr(n)), r("    order", () => he(n)), r("    insertSelfEdges", () => We(n)), r("    adjustCoordinateSystem", () => Rr(n)), r("    position", () => Re(n)), r("    positionSelfEdges", () => nt2(n)), r("    removeBorderNodes", () => Ue(n)), r("    normalize.undo", () => $r(n)), r("    fixupEdgeLabelCoords", () => He(n)), r("    undoCoordinateSystem", () => Mr(n)), r("    translateGraph", () => Ke(n)), r("    assignNodeIntersects", () => Ze(n)), r("    reversePoints", () => Qe(n)), r("    acyclic.undo", () => Er2(n));
}
function je(n, r) {
  _a(n.nodes(), function(e) {
...
var Ce = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"];
var Se = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" };
var $e = ["acyclicer", "ranker", "rankdir", "align"];
var Be = ["width", "height"];
var Fe = { width: 0, height: 0 };
var Ve = ["minlen", "weight", "width", "height", "labeloffset"];
var Ge = {
  minlen: 1,
  weight: 1,
  width: 0,
...
function Ye(n) {
  ...
  return r.setGraph(
    ...
    var o = Y(n.node(t));
    r.setNode(t, ir(q(o, Be), Fe)), r.setParent(t, n.parent(t));
  }), _a(n.edges(), function(t) {
    var o = Y(n.edge(t));
    r.setEdge(
      t,
      _6t({}, Ge, q(o, Ve), T(o, qe))
    );
  }), r;
}
function ze(n) {
...
//# sourceMappingURL=chunk-BIWCY3FE.js.map
