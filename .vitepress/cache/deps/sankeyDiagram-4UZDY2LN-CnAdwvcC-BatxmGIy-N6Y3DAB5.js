...
// node_modules/vitepress-plugin-legend/dist/sankeyDiagram-4UZDY2LN-CnAdwvcC-BatxmGIy.js
function Pt(t) {
  for (var n = t.length / 6 | 0, r = new Array(n), a = 0; a < n; ) r[a] = "#" + t.slice(a * 6, ++a * 6);
  return r;
}
var Ot = Pt("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
function ct(t, n) {
  let r;
  if (n === void 0)
    for (const a of t)
...
function Ft() {
  let t = 0, n = 0, r = 1, a = 1, c = 24, b = 8, _, m = $t, i = _t, o, f, p = jt, y = zt, w = 6;
  function k() {
    const e = { nodes: p.apply(null, arguments), links: y.apply(null, arguments) };
    return O(e), A(e), T(e), D(e), N(e), yt(e), e;
  }
  k.update = function(e) {
    return yt(e), e;
  }, k.nodeId = function(e) {
    return arguments.length ? (m = typeof e == "function" ? e : Y(e), k) : m;
  }, k.nodeAlign = function(e) {
    return arguments.length ? (i = typeof e == "function" ? e : Y(e), k) : i;
    ...
    return arguments.length ? (p = typeof e == "function" ? e : Y(e), k) : p;
  }, k.links = function(e) {
    return arguments.length ? (y = typeof e == "function" ? e : Y(e), k) : y;
  ...
  function N(e) {
    const u = P(e);
    _ = Math.min(b, (a - n) / (ct(u, (l) => l.length) - 1)), S(u);
    for (let l = 0; l < w; ++l) {
  ...
  function I(e, u, l) {
    for (let h = 1, s = e.length; h < s; ++h) {
      ...
      for (const v of x) {
        let W = 0, j = 0;
        for (const { source: V, value: H } of v.targetLinks) {
          let q = H * (v.layer - V.layer);
          W += M(V, v) * q, j += q;
        }
        if (!(j > 0)) continue;
        let R = (W / j - v.y0) * u;
  ...
  function C(e, u, l) {
    for (let h = e.length, s = h - 2; s >= 0; --s) {
      ...
      for (const v of x) {
        let W = 0, j = 0;
        for (const { target: V, value: H } of v.sourceLinks) {
          let q = H * (V.layer - v.layer);
          W += G(v, V) * q, j += q;
        }
        if (!(j > 0)) continue;
  ...
  function g2(e, u) {
    ...
    U(e, h.y0 - _, l - 1, u), L(e, h.y1 + _, l + 1, u), U(e, a, e.length - 1, u), L(e, n, 0, u);
  }
  function L(e, u, l, h) {
    for (; l < e.length; ++l) {
...
ot.prototype = mt.prototype = {
  ...
  arcTo: function(t, n, r, a, c) {
    ...
    if (this._x1 === null)
      ...
      var y = r - b, w = a - _, k = m * m + i * i, O = y * y + w * w, A = Math.sqrt(k), T = Math.sqrt(p), D = c * Math.tan((rt - Math.acos((k + p - O) / (2 * A * T))) / 2), P = D / T, S = D / A;
  ...
  arc: function(t, n, r, a, c, b) {
    ...
    this._x1 === null ? this._ += "M" + i + "," + o : (Math.abs(this._x1 - i) > z || Math.abs(this._y1 - o) > z) && (this._ += "L" + i + "," + o), r && (p < 0 && (p = p % st + st), p > Ut ? this._ += "A" + r + "," + r + ",0,1," + f + "," + (t - _) + "," + (n - m) + "A" + r + "," + r + ",0,1," + f + "," + (this._x1 = i) + "," + (this._y1 = o) : p > z && (this._ += "A" + r + "," + r + ",0," + +(p >= rt) + "," + f + "," + (this._x1 = t + r * Math.cos(c)) + "," + (this._y1 = n + r * Math.sin(c))));
  },
...
function Xt(t) {
  var n = Vt, r = qt, a = Gt, c = Wt, b = null;
  function _() {
    var m, i = Rt.call(arguments), o = n.apply(this, i), f = r.apply(this, i);
...
function Bt() {
  return Qt().source(Zt).target(Kt);
}
var at = (function() {
  var t = F(function(m, i, o, f) {
    ...
    performAction: F(function(m, i, o, f, p, y, w) {
      var k = y.length - 1;
      switch (p) {
        case 7:
          const O = f.findOrCreateNode(y[k - 4].trim().replaceAll('""', '"')), A = f.findOrCreateNode(y[k - 2].trim().replaceAll('""', '"')), T = parseFloat(y[k].trim());
          f.addLink(O, A, T);
          break;
        case 8:
        case 9:
    ...
    parse: F(function(m) {
      var i = this, o = [0], f = [], p = [null], y = [], w = this.table, k = "", O = 0, A = 0, T = 2, D = 1, P = y.slice.call(arguments, 1), S = Object.create(this.lexer), N = { yy: {} };
...
` + S.showPosition() + `
Expecting ` + s.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : x = "Parse error on line " + (O + 1) + ": Unexpected " + (E == D ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(x, {
            text: S.match,
        ...
        switch (M[0]) {
          case 1:
            o.push(E), p.push(S.yytext), y.push(S.yylloc), o.push(M[1]), E = null, A = S.yyleng, k = S.yytext, O = S.yylineno, C = S.yylloc;
            break;
          case 2:
...
` + this.showPosition(), {
      ...
      performAction: F(function(i, o, f, p) {
        switch (f) {
          case 0:
  ...
  return F(_, "Parser"), _.prototype = c, c.Parser = _, new _();
})();
at.parser = at;
var Z = at;
var B = [];
...
var oe = {
  nodesMap: K,
  getConfig: F(() => _n().sankey, "getConfig"),
  getNodes: ie,
  getLinks: re,
  getGraph: se,
  addLink: te,
...
var le = F(function(t, n, r, a) {
  const { securityLevel: c, sankey: b } = _n(), _ = vre.sankey;
  let m;
  c === "sandbox" && (m = gn("#i" + n));
  const i = c === "sandbox" ? gn(m.nodes()[0].contentDocument.body) : gn("body"), o = c === "sandbox" ? i.select(`[id="${n}"]`) : gn(`[id="${n}"]`), f = b?.width ?? _.width, p = b?.height ?? _.width, y = b?.useMaxWidth ?? _.useMaxWidth, w = b?.nodeAlignment ?? _.nodeAlignment, k = b?.prefix ?? _.prefix, O = b?.suffix ?? _.suffix, A = b?.showValues ?? _.showValues, T = a.db.getGraph(), D = ae[w];
  ...
  const S = F(({ id: g2, value: L }) => A ? `${g2}
${k}${Math.round(L * 100) / 100}${O}` : g2, "getText");
  ...
  const N = o.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(T.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), I = b?.linkColor ?? "gradient";
  if (I === "gradient") {
  ...
  switch (I) {
    case "gradient":
      C = F((g2) => g2.uid, "coloring");
      break;
    case "source":
      C = F((g2) => P(g2.source.id), "coloring");
      break;
    case "target":
      C = F((g2) => P(g2.target.id), "coloring");
      break;
    default:
      C = I;
  }
  N.append("path").attr("d", Bt()).attr("stroke", C).attr("stroke-width", (g2) => Math.max(1, g2.width)), X2t(void 0, o, 0, y);
}, "draw");
var ce = {
  draw: le
};
var he = F((t) => t.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, `
`).trim(), "prepareTextForParsing");
var ue = F((t) => `.label {
      font-family: ${t.fontFamily};
    }`, "getStyles");
var fe = ue;
var ye = Z.parse.bind(Z);
Z.parse = (t) => ye(he(t));
var de = {
  styles: fe,
  parser: Z,
...
//# sourceMappingURL=sankeyDiagram-4UZDY2LN-CnAdwvcC-BatxmGIy-N6Y3DAB5.js.map
