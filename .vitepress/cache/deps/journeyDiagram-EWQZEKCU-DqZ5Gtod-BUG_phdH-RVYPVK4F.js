...
// node_modules/vitepress-plugin-legend/dist/journeyDiagram-EWQZEKCU-DqZ5Gtod-BUG_phdH.js
var U = (function() {
  var t = F(function(d2, i, a, u) {
    ...
    performAction: F(function(d2, i, a, u, p, o2, x) {
      var k = o2.length - 1;
      switch (p) {
        case 1:
          return o2[k - 1];
    ...
    parse: F(function(d2) {
      var i = this, a = [0], u = [], p = [null], o2 = [], x = this.table, k = "", T = 0, A = 0, ut = 2, Z = 1, pt = o2.slice.call(arguments, 1), b = Object.create(this.lexer), I = { yy: {} };
      for (var Y in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Y) && (I.yy[Y] = this.yy[Y]);
      b.setInput(d2, I.yy), I.yy.lexer = b, I.yy.parser = this, typeof b.yylloc > "u" && (b.yylloc = {});
      var z = b.yylloc;
      o2.push(z);
      ...
      F(J, "lex");
      for (var _, P, $, W, j = {}, D, M, K, O; ; ) {
        if (P = a[a.length - 1], this.defaultActions[P] ? $ = this.defaultActions[P] : ((_ === null || typeof _ > "u") && (_ = J()), $ = x[P] && x[P][_]), typeof $ > "u" || !$.length || !$[0]) {
          var G = "";
          O = [];
          for (D in x[P])
...
Expecting ` + O.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : G = "Parse error on line " + (T + 1) + ": Unexpected " + (_ == Z ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(G, {
        ...
        switch ($[0]) {
          case 1:
            a.push(_), p.push(b.yytext), o2.push(b.yylloc), a.push($[1]), _ = null, A = b.yyleng, k = b.yytext, T = b.yylineno, z = b.yylloc;
            break;
          case 2:
            if (M = this.productions_[$[1]][1], j.$ = p[p.length - M], j._$ = {
              first_line: o2[o2.length - (M || 1)].first_line,
              last_line: o2[o2.length - 1].last_line,
              first_column: o2[o2.length - (M || 1)].first_column,
              last_column: o2[o2.length - 1].last_column
            }, yt && (j._$.range = [
              o2[o2.length - (M || 1)].range[0],
              ...
              return W;
            M && (a = a.slice(0, -1 * M * 2), p = p.slice(0, -1 * M), o2 = o2.slice(0, -1 * M)), a.push(this.productions_[$[1]][0]), p.push(j.$), o2.push(j._$), K = x[a[a.length - 2]][a[a.length - 1]], a.push(K);
            break;
          case 3:
            return true;
        }
...
` + this.showPosition(), {
      ...
      performAction: F(function(i, a, u, p) {
        switch (u) {
          case 0:
            break;
          case 1:
  ...
  return F(g2, "Parser"), g2.prototype = f, f.Parser = g2, new g2();
})();
U.parser = U;
var Ct = U;
var V = "";
...
var R = [];
var Et = F(function() {
  X.length = 0, F2.length = 0, V = "", R.length = 0, Q2t();
}, "clear");
var Tt = F(function(t) {
  V = t, X.push(t);
}, "addSection");
...
var it = {
  getConfig: F(() => _n().journey, "getConfig"),
  clear: Et,
  setDiagramTitle: rbt,
  getDiagramTitle: ibt,
  setAccTitle: J2t,
...
`, "getStyles");
var Rt = Ft;
var Q = F(function(t, e) {
  return o(t, e);
}, "drawRect");
var Lt = F(function(t, e) {
  ...
  return F(c, "ambivalent"), e.score > 3 ? n(l2) : e.score < 3 ? y(l2) : c(l2), r;
}, "drawFace");
var ot = F(function(t, e) {
...
var nt = -1;
var Nt = F(function(t, e, r) {
  const l2 = e.x + r.width / 2, n = t.append("g");
  nt++;
  const y = 300 + 5 * 30;
  n.append("line").attr("id", "task" + nt).attr("x1", l2).attr("y1", e.y).attr("x2", l2).attr("y2", y).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Lt(n, {
    cx: l2,
    cy: 300 + (5 - e.score) * 30,
    score: e.score
  });
...
var ct = (function() {
  ...
  return F(l2, "_setTextAttrs"), function(n) {
...
var N = 0;
function ht(t) {
  const e = _n().journey, r = e.maxLabelWidth;
  N = 0;
  let l2 = 60;
  Object.keys(C).forEach((n) => {
    ...
    m.forEach((g2, d2) => {
      ...
      }, a = L.drawText(t, i).node().getBoundingClientRect().width;
      a > N && a > e.leftMargin - a && (N = a);
    }), l2 += Math.max(20, m.length * 20);
  });
}
F(ht, "drawActorLegend");
var S = _n().journey;
var E = 0;
var Gt = F(function(t, e, r, l2) {
  const n = _n(), y = n.journey.titleColor, c = n.journey.titleFontSize, h2 = n.journey.titleFontFamily, f = n.securityLevel;
  let m;
  f === "sandbox" && (m = gn("#i" + e));
  const g2 = f === "sandbox" ? gn(m.nodes()[0].contentDocument.body) : gn("body");
  v.init();
  ...
  }), ht(d2), E = S.leftMargin + N, v.insert(0, 0, E, Object.keys(C).length * 50), qt(d2, i, 0);
  const o2 = v.getBounds();
  a && d2.append("text").text(a).attr("x", E).attr("font-size", c).attr("font-weight", "bold").attr("y", 25).attr("fill", y).attr("font-family", h2);
  const x = o2.stopy - o2.starty + 2 * S.diagramMarginY, k = E + o2.stopx + 2 * S.diagramMarginX;
  uW(d2, x, k, S.useMaxWidth), d2.append("line").attr("x1", E).attr("y1", S.height * 4).attr("x2", k - E - 4).attr("y2", S.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const T = a ? 70 : 0;
  d2.attr("viewBox", `${o2.startx} -25 ${k} ${x + T}`), d2.attr("preserveAspectRatio", "xMinYMin meet"), d2.attr("height", x + T + 25);
}, "draw");
var v = {
  data: {
    startx: void 0,
  ...
  updateVal: F(function(t, e, r, l2) {
    t[e] === void 0 ? t[e] = r : t[e] = l2(r, t[e]);
  }, "updateVal"),
  updateBounds: F(function(t, e, r, l2) {
    const n = _n().journey, y = this;
    let c = 0;
    function h2(f) {
      return F(function(m) {
        c++;
    ...
    F(h2, "updateFn"), this.sequenceItems.forEach(h2());
  }, "updateBounds"),
  insert: F(function(t, e, r, l2) {
  ...
  for (const [d2, i] of e.entries()) {
    if (n !== i.section) {
      ...
      for (let x = d2; x < e.length && e[x].section == p; x++)
        u = u + 1;
      const o2 = {
        x: d2 * l2.taskMargin + d2 * l2.width + E,
        y: 50,
        text: i.section,
        fill: f,
        num: g2,
      ...
      L.drawSection(t, o2, l2), n = i.section, h2++;
    }
    const a = i.people.reduce((u, p) => (C[p] && (u[p] = C[p]), u), {});
    i.x = d2 * l2.taskMargin + d2 * l2.width + E, i.y = c, i.width = l2.diagramMarginX, i.height = l2.diagramMarginY, i.colour = m, i.fill = f, i.num = g2, i.actors = a, L.drawTask(t, i, l2), v.insert(i.x, i.y, i.x + i.width + l2.taskMargin, 300 + 5 * 30);
  }
}, "drawTasks");
var at = {
  setConf: Wt,
...
//# sourceMappingURL=journeyDiagram-EWQZEKCU-DqZ5Gtod-BUG_phdH-RVYPVK4F.js.map
