...
// node_modules/vitepress-plugin-legend/dist/graph-CQdm8gkL-DRxsSVK0.js
var D = k6t(function(o) {
  return ka(wa(o, 1, pwt, true));
});
var F = "\0";
var d = "\0";
var C = "";
var y = class {
  ...
  setDefaultNodeLabel(t) {
    return iC(t) || (t = g6t(t)), this._defaultNodeLabelFn = t, this;
  }
  nodeCount() {
  ...
  setParent(t, e) {
    ...
    if (Oa(e))
      ...
      e += "";
      for (var s = e; !Oa(s); s = this.parent(s))
        if (s === t)
  ...
  setDefaultEdgeLabel(t) {
    return iC(t) || (t = g6t(t)), this._defaultEdgeLabelFn = t, this;
  }
  edgeCount() {
    return this._edgeCount;
  }
  edges() {
    return ma(this._edgeObjs);
  }
  setPath(t, e) {
  ...
  setEdge() {
    ...
    typeof n == "object" && n !== null && "v" in n ? (t = n.v, e = n.w, s = n.name, arguments.length === 2 && (r = arguments[1], i = true)) : (t = n, e = arguments[1], s = arguments[3], arguments.length > 2 && (r = arguments[2], i = true)), t = "" + t, e = "" + e, Oa(s) || (s = "" + s);
...
//# sourceMappingURL=chunk-QDHDAQB6.js.map
