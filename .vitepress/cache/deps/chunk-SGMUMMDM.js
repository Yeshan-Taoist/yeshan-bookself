...
// node_modules/vitepress-plugin-legend/dist/mermaid-parser.core-BppQlyDy-CFOK0vkl.js
var Oc = Object.prototype;
var _c = Oc.hasOwnProperty;
var Ae = C6t(function(r, e) {
  if (Ry(e) || qy(e)) {
    t6t(e, A(e), r);
    return;
  }
  for (var t in e)
    _c.call(e, t) && Jwt(r, t, e[t]);
});
function wl(r, e, t) {
  var n2 = -1, i = r.length;
...
function Uc(r, e, t, n2) {
  var i = -1, s = Kr, a = true, o = r.length, l = [], u = e.length;
  if (!o)
    return l;
  e.length >= Fc && (s = Or, a = false, e = new k(e));
  e:
    for (; ++i < o; ) {
      var c = r[i], d = c;
      if (c = c !== 0 ? c : 0, a && d === d) {
...
var qn = k6t(function(r, e) {
  return pwt(r) ? Uc(r, wa(e, 1, pwt, true)) : [];
});
function J(r, e, t) {
  var n2 = r == null ? 0 : r.length;
  return n2 ? (e = e === void 0 ? 1 : U(e), wl(r, e < 0 ? 0 : e, n2)) : [];
}
function wr(r, e, t) {
  var n2 = r == null ? 0 : r.length;
  return n2 ? (e = e === void 0 ? 1 : U(e), e = n2 - e, wl(r, 0, e < 0 ? 0 : e)) : [];
}
function Gc(r, e) {
...
var jc = Dc(function(r, e, t) {
  Vc.call(r, t) ? r[t].push(e) : oC(r, t, [e]);
});
var Hc = "[object String]";
function he(r) {
  return typeof r == "string" || !tm(r) && yf(r) && xu(r) == Hc;
}
var Wc = Math.max;
function de(r, e, t, n2) {
  r = qy(r) ? r : ma(r), t = t ? U(t) : 0;
  var i = r.length;
  return t < 0 && (t = Wc(i + t, 0)), he(r) ? t <= i && r.indexOf(e, t) > -1 : !!i && Hr(r, e, t) > -1;
}
function ya(r, e, t) {
  var n2 = r == null ? 0 : r.length;
  if (!n2)
...
function Me(r, e) {
  if (r == null)
    return {};
  var t = br(ht(r), function(n2) {
    return [n2];
  });
  return e = Er(e), gr2(r, t, function(n2, i) {
    return e(n2, i[0]);
  });
}
function Xn(r, e) {
...
function Bs(r) {
  return r && r.length ? ka(r) : [];
}
function Jc(r, e) {
  return r && r.length ? ka(r, Er(e)) : [];
}
function ae(r) {
...
var Ks = class extends Z {
  constructor(e, t, n2) {
    super(() => ({
      iterators: n2?.includeRoot ? [[e][Symbol.iterator]()] : [t(e)[Symbol.iterator]()],
      pruned: false
    }), (i) => {
...
var pr = "RuleCall";
function yt(r) {
  return M.isInstance(r, pr);
}
var mr = "TerminalAlternatives";
function Rd(r) {
  return M.isInstance(r, mr);
}
var gr3 = "TerminalGroup";
function $d(r) {
  return M.isInstance(r, gr3);
}
var yr = "TerminalRuleCall";
function Ed(r) {
  return M.isInstance(r, yr);
}
var Tr2 = "UnorderedGroup";
function Gl(r) {
  return M.isInstance(r, Tr2);
}
var vr2 = "UntilToken";
function Ad(r) {
...
var Bl = class extends bl {
  getAllTypes() {
    return [zt, Kr2, Vr, ir2, sr2, jr, Hr2, ar, Yt, or, fi, qt, lr2, Xt, ur, Wr, pi, cr2, Qt, Jt, dr, mi, fr2, Zt, zr, Yr, er2, tr, qr, hr, fn, pr, rr, Xr, mr, gr3, Ct, yr, nr, gi, Ra, Qr, Tr2, vr2, hi, Rr];
  }
...
function us(r) {
  ...
  return e && e.atLeast === 0 ? true : r.value ? tm(r.value) ? _e(r.value, us) : us(r.value) : false;
}
...
`],
  ...
  t("Transform Patterns", () => {
    i = false, s = lr(n2, ($) => {
      ...
      if (Xe(T)) {
        ...
        I !== "^" && I !== "$" && I !== "." && !T.ignoreCase ? I : I.length === 2 && I[0] === "\\" && // not a meta character
        !de([
          "d",
          "D",
          "s",
          ...
          "w",
          "W"
        ], I[1]) ? I[1] : e.useSticky ? Sa2(T) : Ia(T);
      } else {
        if (iC(T))
        ...
        if (typeof T == "string") {
          if (T.length === 1)
            return T;
          {
            const I = T.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"), G = new RegExp(I);
            return e.useSticky ? Sa2(G) : Ia(G);
          }
        } else
          throw Error("non exhaustive match");
      }
  ...
  t("misc mapping", () => {
    a = lr(n2, ($) => $.tokenTypeIdx), o = lr(n2, ($) => {
      ...
      const T = $.LONGER_ALT;
      if (T)
        return tm(T) ? lr(T, (I) => ya(n2, I)) : [ya(n2, T)];
    }), u = lr(n2, ($) => $.PUSH_MODE), c = lr(n2, ($) => cr($, "POP_MODE"));
  });
  let d;
  t("Line Terminator Handling", () => {
    const $ = au(e.lineTerminatorCharacters);
    d = lr(n2, (T) => false), e.positionTracking !== "onlyOffset" && (d = lr(n2, (T) => cr(T, "LINE_BREAKS") ? !!T.LINE_BREAKS : su(T, $) === false && Qs($, T.PATTERN)));
  });
  let f, h, m, g;
  t("Misc Mapping #2", () => {
    f = lr(n2, iu), h = lr(s, Df), m = Sa(n2, ($, T) => {
      const I = T.GROUP;
      return he(I) && I !== fe.SKIPPED && ($[I] = []), $;
    }, {}), g = lr(s, ($, T) => ({
      pattern: s[T],
      longerAlt: l[T],
  ...
  return e.safeMode || t("First Char Optimization", () => {
    R2 = Sa(n2, ($, T, I) => {
      if (typeof T.PATTERN == "string") {
        ...
        if (T.PATTERN.unicode)
          k2 = false, e.ensureOptimizations && os(`${Ln}	Unable to analyze < ${T.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
        else {
          const G = pf(T.PATTERN, e.ensureOptimizations);
          QT(G) && (k2 = false), _a(G, (ie) => {
            Ri($, ie, g[I]);
          });
        }
      else
	...
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_OPTIMIZE`), k2 = false;
      return $;
    }, []);
  }), {
    emptyGroups: m,
...
function Rf(r) {
  const e = Aa(r, (i) => !cr(i, Tt)), t = lr(e, (i) => ({
...
function $f(r) {
  const e = Aa(r, (i) => {
    const s = i[Tt];
    return !Xe(s) && !iC(s) && !cr(s, "exec") && !he(s);
  }), t = lr(e, (i) => ({
...
`,
  ...
  }), cr(r, en) && cr(r, $r) && !cr(r.modes, r.defaultMode) && n2.push({
...
`,
      ...
      else if (cr(a, "LONGER_ALT")) {
        const l = tm(a.LONGER_ALT) ? a.LONGER_ALT : [a.LONGER_ALT];
        _a(l, (u) => {
          !Oa(u) && !de(i, u) && n2.push({
...
function Pf(r, e, t) {
  ...
  return e && _a(a, (l) => {
    ...
    if (u !== false) {
      ...
      cr(l, "LINE_BREAKS") ? l.LINE_BREAKS === true && (i = true) : Qs(o, l.PATTERN) && (i = true);
  }), e && !i && n2.push({
...
function Bf(r) {
  ...
  for (; n2; ) {
    ...
    const i = qn(t, e);
    e = e.concat(i), QT(i) ? n2 = false : t = i;
  }
  return e;
}
function Kf(r) {
  _a(r, (e) => {
    uu(e) || (ou[Ca] = e, e.tokenTypeIdx = Ca++), Na(e) && !tm(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), Na(e) || (e.CATEGORIES = []), Hf(e) || (e.categoryMatches = []), Wf(e) || (e.categoryMatchesMap = {});
  });
}
function Vf(r) {
  _a(r, (e) => {
...
function uu(r) {
  return cr(r, "tokenTypeIdx");
}
function Na(r) {
  return cr(r, "CATEGORIES");
}
function Hf(r) {
  return cr(r, "categoryMatches");
}
function Wf(r) {
  return cr(r, "categoryMatchesMap");
}
function zf(r) {
  return cr(r, "tokenTypeIdx");
}
...
a boolean 2nd argument is no longer supported`);
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
        ...
        this.trackStartLines = /full|onlyStart/i.test(this.config.positionTracking), this.trackEndLines = /full/i.test(this.config.positionTracking), tm(e) ? i = {
      ...
      }), this.defaultMode = i.defaultMode, !QT(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
...
` + o);
      ...
      _a(this.lexerDefinitionWarning, (o) => {
        ...
        if (nu ? (this.chopInput = iG, this.match = this.matchWithTest) : (this.updateLastIndex = Tr, this.match = this.matchWithExec), s && (this.handleModes = Tr), this.trackStartLines === false && (this.computeNewColumn = iG), this.trackEndLines === false && (this.updateTokenEndLineColumnLocation = Tr), /full/i.test(this.config.positionTracking))
  ...
  tokenize(e, t = this.defaultMode) {
    if (!QT(this.lexerDefinitionErrors)) {
...
` + n2);
  ...
  tokenizeInternal(e, t) {
    let n2, i, s, a, o, l, u, c, d, f, h, m, g, k2, R2;
    const $ = e, T = $.length;
    let I = 0, G = 0;
    ...
    for (; I < T; ) {
      l = null;
      const se = $.charCodeAt(I), Ce = Y(se), It = Ce.length;
      for (n2 = 0; n2 < It; n2++) {
        be = Ce[n2];
        const ve = be.pattern;
        u = null;
        const Ke = be.short;
        if (Ke !== false ? se === Ke && (l = ve) : be.isCustom === true ? (R2 = ve.exec($, I, Le, E), R2 !== null ? (l = R2[0], R2.payload !== void 0 && (u = R2.payload)) : l = null) : (this.updateLastIndex(ve, I), l = this.match(ve, e, I)), l !== null) {
          if (o = be.longerAlt, o !== void 0) {
            const Je = o.length;
            for (s = 0; s < Je; s++) {
              const Ve = O[o[s]], dt = Ve.pattern;
              if (c = null, Ve.isCustom === true ? (R2 = dt.exec($, I, Le, E), R2 !== null ? (a = R2[0], R2.payload !== void 0 && (c = R2.payload)) : a = null) : (this.updateLastIndex(dt, I), a = this.match(dt, e, I)), a && a.length > l.length) {
                l = a, u = c, be = Ve;
                break;
              }
            }
      ...
      if (l !== null) {
        if (d = l.length, f = be.group, f !== void 0 && (h = be.tokenTypeIdx, m = this.createTokenInstance(l, I, h, be.tokenType, Fe, Se2, d), this.handlePayload(m, u), f === false ? G = this.addToken(Le, G, m) : E[f].push(m)), e = this.chopInput(e, d), I = I + d, Se2 = this.computeNewColumn(Se2, d), y === true && be.canLineTerminator === true) {
          let ve = 0, Ke, Je;
          S.lastIndex = 0;
          do
        ...
        const ve = I, Ke = Fe, Je = Se2;
        let Ve = fa === false;
        for (; Ve === false && I < T; )
          for (e = this.chopInput(e, 1), I++, i = 0; i < x; i++) {
            const dt = O[i], di = dt.pattern, ha = dt.short;
            if (ha !== false ? $.charCodeAt(I) === ha && (Ve = true) : dt.isCustom === true ? Ve = di.exec($, I, Le, E) !== null : (this.updateLastIndex(di, I), Ve = di.exec(e) !== null), Ve === true)
              break;
          }
        if (g = I - ve, Se2 = this.computeNewColumn(Se2, g), k2 = this.config.errorMessageProvider.buildUnexpectedCharactersMessage($, ve, g, Ke, Je), ye.push({
          offset: ve,
          line: Ke,
          column: Je,
          length: g,
...
function qf(r) {
  const e = r.pattern, t = {};
  if (t.name = r.name, Oa(e) || (t.PATTERN = e), cr(r, Yf))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return cr(r, wa2) && (t.CATEGORIES = r[wa2]), Ur([t]), cr(r, La) && (t.LABEL = r[La]), cr(r, ba) && (t.GROUP = r[ba]), cr(r, _a2) && (t.POP_MODE = r[_a2]), cr(r, Oa2) && (t.PUSH_MODE = r[Oa2]), cr(r, Pa) && (t.LONGER_ALT = r[Pa]), cr(r, Ma) && (t.LINE_BREAKS = r[Ma]), cr(r, Da) && (t.START_CHARS_HINT = r[Da]), t;
}
...
var Zf = class extends ti {
  ...
  updateExpectedNext() {
    QT(this.ruleStack) ? (this.nextProductionName = "", this.nextProductionOccurrence = 0, this.isAtEndOfPath = true) : (this.nextProductionName = this.ruleStack.pop(), this.nextProductionOccurrence = this.occurrenceStack.pop());
  }
};
    ...
    if (o instanceof re)
      ...
      if (o instanceof ge)
        return _a(o.definition, (l) => {
          QT(l.definition) === false && (n2 = a(l.definition));
        }), n2;
      if (o instanceof F)
...
function hu(r, e, t, n2) {
  ...
  for (d.push({
    ...
    const h = f.def, m = f.idx, g = f.ruleStack, k2 = f.occurrenceStack;
    if (QT(h))
      continue;
    const R2 = h[0];
    if (R2 === i) {
      ...
      const $ = new F({
        ...
        idx: R2.idx
      }), I = R2.definition.concat([T], J(h)), G = {
        idx: m,
        def: I,
        ruleStack: g,
        occurrenceStack: k2
      ...
      const T = new F({
        ...
        idx: R2.idx
      }), G = R2.definition.concat([I], J(h)), ie = {
        idx: m,
        def: G,
        ruleStack: g,
        occurrenceStack: k2
...
function ah(r, e, t, n2) {
  ...
  if (s && !n2) {
    const a = lr(r, (l) => er(l)), o = Sa(a, (l, u, c) => (_a(u, (d) => {
      cr(l, d.tokenTypeIdx) || (l[d.tokenTypeIdx] = c), _a(d.categoryMatches, (f) => {
        cr(l, f) || (l[f] = c);
      });
    }), l), {});
    return function() {
...
function oh(r, e, t) {
  ...
  if (n2 && !t) {
    const s = er(r);
    if (s.length === 1 && QT(s[0].categoryMatches)) {
...
function gu(r) {
  return _e(r, (e) => _e(e, (t) => _e(t, (n2) => QT(n2.categoryMatches))));
}
function dh(r) {
...
var Ei = {};
var xu2 = "InRuleRecoveryException";
var Lh = class extends Error {
  constructor(e) {
    super(e), this.name = xu2;
  }
};
var bh = class {
  initRecoverable(e) {
    this.firstAfterRepMap = {}, this.resyncFollows = {}, this.recoveryEnabled = cr(e, "recoveryEnabled") ? e.recoveryEnabled : Qe.recoveryEnabled, this.recoveryEnabled && (this.attemptInRepetitionRecovery = Oh);
  }
  getTokenToInsert(e) {
  ...
  canRecoverWithSingleTokenInsertion(e, t) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || QT(t))
      return false;
    const n2 = this.LA(1);
...
var ta = class {
  constructor(e) {
    var t;
    this.maxLookahead = (t = e?.maxLookahead) !== null && t !== void 0 ? t : Qe.maxLookahead;
  }
  validate(e) {
...
var Ph = class {
  initLooksAhead(e) {
    this.dynamicTokensEnabled = cr(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : Qe.dynamicTokensEnabled, this.maxLookahead = cr(e, "maxLookahead") ? e.maxLookahead : Qe.maxLookahead, this.lookaheadStrategy = cr(e, "lookaheadStrategy") ? e.lookaheadStrategy : new ta({ maxLookahead: this.maxLookahead }), this.lookAheadFuncsCache = /* @__PURE__ */ new Map();
  }
...
function Hh(r, e) {
  const t = Aa(e, (i) => iC(r[i]) === false), n2 = lr(t, (i) => ({
...
var Wh = class {
  initTreeBuilder(e) {
    if (this.CST_STACK = [], this.outputCst = e.outputCst, this.nodeLocationTracking = cr(e, "nodeLocationTracking") ? e.nodeLocationTracking : Qe.nodeLocationTracking, !this.outputCst)
      this.cstInvocationStateUpdate = Tr, this.cstFinallyStateUpdate = Tr, this.cstPostTerminal = Tr, this.cstPostNonTerminal = Tr, this.cstPostRule = Tr;
    else if (/full/i.test(this.nodeLocationTracking))
      this.recoveryEnabled ? (this.setNodeLocationFromToken = Va, this.setNodeLocationFromNode = Va, this.cstPostRule = Tr, this.setInitialNodeLocation = this.setInitialNodeLocationFullRecovery) : (this.setNodeLocationFromToken = Tr, this.setNodeLocationFromNode = Tr, this.cstPostRule = this.cstPostRuleFull, this.setInitialNodeLocation = this.setInitialNodeLocationFullRegular);
    else if (/onlyOffset/i.test(this.nodeLocationTracking))
      this.recoveryEnabled ? (this.setNodeLocationFromToken = Ka, this.setNodeLocationFromNode = Ka, this.cstPostRule = Tr, this.setInitialNodeLocation = this.setInitialNodeLocationOnlyOffsetRecovery) : (this.setNodeLocationFromToken = Tr, this.setNodeLocationFromNode = Tr, this.cstPostRule = this.cstPostRuleOnlyOffset, this.setInitialNodeLocation = this.setInitialNodeLocationOnlyOffsetRegular);
    else if (/none/i.test(this.nodeLocationTracking))
      this.setNodeLocationFromToken = Tr, this.setNodeLocationFromNode = Tr, this.cstPostRule = Tr, this.setInitialNodeLocation = Tr;
    else
...
var qh = class {
  initRecognizerEngine(e, t) {
    ...
    else if (cr(e, "modes") && _e(er(ma(e.modes)), zf)) {
    ...
    const n2 = cr(e, "modes") ? er(ma(e.modes)) : ma(e), i = _e(n2, (s) => QT(s.categoryMatches));
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const i = cr(n2, "resyncEnabled") ? n2.resyncEnabled : Mn.resyncEnabled, s = cr(n2, "recoveryValueFunc") ? n2.recoveryValueFunc : Mn.recoveryValueFunc, a = this.ruleShortNameIdx << _h + it;
  ...
  orInternal(e, t) {
    const n2 = this.getKeyForAutomaticLookahead(Iu, t), i = tm(e) ? e : e.DEF, s = this.getLaFuncFromCache(n2).call(this, i);
    if (s !== void 0)
...
var Xh = class {
  initErrorHandler(e) {
    this._errors = [], this.errorMessageProvider = cr(e, "errorMessageProvider") ? e.errorMessageProvider : Qe.errorMessageProvider;
  }
  SAVE_ERROR(e) {
    if (On(e))
      return e.context = {
...
function Ht(r, e, t, n2 = false) {
  _n(t);
  const i = fr(this.recordingProdStack), s = iC(e) ? e : e.DEF, a = new r({ definition: [], idx: t });
  return n2 && (a.separator = e.SEP), cr(e, "MAX_LOOKAHEAD") && (a.maxLookahead = e.MAX_LOOKAHEAD), this.recordingProdStack.push(a), s.call(this), i.definition.push(a), this.recordingProdStack.pop(), oi;
}
function ep(r, e) {
  _n(e);
  const t = fr(this.recordingProdStack), n2 = tm(r) === false, i = n2 === false ? r : r.DEF, s = new ge({
    definition: [],
    idx: e,
    ignoreAmbiguities: n2 && r.IGNORE_AMBIGUITIES === true
  });
  cr(r, "MAX_LOOKAHEAD") && (s.maxLookahead = r.MAX_LOOKAHEAD);
  const a = Ll(i, (o) => iC(o.GATE));
  return s.hasPredicates = a, t.definition.push(s), _a(i, (o) => {
    const l = new pe({ definition: [] });
    s.definition.push(l), cr(o, "IGNORE_AMBIGUITIES") ? l.ignoreAmbiguities = o.IGNORE_AMBIGUITIES : cr(o, "GATE") && (l.ignoreAmbiguities = true), this.recordingProdStack.push(l), o.ALT.call(this), this.recordingProdStack.pop();
  }), oi;
}
function Wa(r) {
  return r === 0 ? "" : `${r}`;
  ...
  performSelfAnalysis() {
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (this.TRACE_INIT("Grammar Resolving", () => {
        ...
        if (QT(n2) && this.skipValidations === false) {
          const i = Sh({
            rules: ma(this.gastProductionsCache),
      ...
      }), QT(this.definitionErrors) && (this.recoveryEnabled && this.TRACE_INIT("computeAllProdsFollows", () => {
      ...
      })), !_Gr.DEFER_DEFINITION_ERRORS_HANDLING && !QT(this.definitionErrors))
...
`)}`);
  ...
  constructor(e, t) {
    ...
    const n2 = this;
    if (n2.initErrorHandler(t), n2.initLexerAdapter(), n2.initLooksAhead(t), n2.initRecognizerEngine(e, t), n2.initRecoverable(t), n2.initTreeBuilder(t), n2.initContentAssist(), n2.initGastRecorder(t), n2.initPerformanceTracer(t), cr(t, "ignoredIssues"))
      throw new Error(`The <ignoredIssues> IParserConfig property has been deprecated.
	Please use the <IGNORE_AMBIGUITIES> flag on the relevant DSL method instead.
	See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#IGNORING_AMBIGUITIES
	For further details.`);
    this.skipValidations = cr(t, "skipValidations") ? t.skipValidations : Qe.skipValidations;
  }
};
...
var kp = class extends ta {
  constructor(e) {
    var t;
    super(), this.logging = (t = e?.logging) !== null && t !== void 0 ? t : (n2) => console.log(n2);
  }
  initialize(e) {
  ...
  buildLookaheadForAlternation(e) {
    ...
    if (qa(c, false) && !s) {
      const d = Sa(c, (f, h, m) => (_a(h, (g) => {
        g && (f[g.tokenTypeIdx] = m, _a(g.categoryMatches, (k2) => {
          f[k2] = m;
        }));
      }), f), {});
      return i ? function(f) {
        ...
        if (f !== void 0 && g !== void 0) {
          const k2 = (h = f[g]) === null || h === void 0 ? void 0 : h.GATE;
          if (k2 !== void 0 && k2.call(this) === false)
            return;
        }
        return g;
      } : function() {
      ...
      for (let g = 0; g < h; g++) {
        const k2 = d?.[g].GATE;
        f.set(g, k2 === void 0 || k2.call(this));
      }
  ...
  buildLookaheadForOptional(e) {
    ...
    if (qa(c) && c[0][0] && !s) {
      const d = c[0], f = er(d);
      if (f.length === 1 && QT(f[0].categoryMatches)) {
        const h = f[0].tokenTypeIdx;
        return function() {
          return this.LA(1).tokenTypeIdx === h;
        };
      } else {
        const h = Sa(f, (m, g) => (g !== void 0 && (m[g.tokenTypeIdx] = true, _a(g.categoryMatches, (k2) => {
          m[k2] = true;
        })), m), {});
        return function() {
          const m = this.LA(1);
...
var Hp = class {
  ...
  construct(e) {
    ...
    n2?.content.length === 0 && this.removeNode(n2);
  }
};
var Ku = class {
...
var bs = /* @__PURE__ */ Symbol("Datatype");
function xi(r) {
  return r.$type === bs;
}
var Zo = "​";
  ...
  const n2 = r.or++, i = (o, l) => {
    ...
    c.ALT = () => {
      if (l.ALT(o), !d.isRecording()) {
        ...
        typeof m?.[u] > "u" && (m[u] = true);
      }
    };
    const f = l.GATE;
    return f ? c.GATE = () => f(o) : c.GATE = () => !d.unorderedGroups.get(i(n2, d))?.[u], c;
  })), a = qu(r, jn(e), s, "*");
  return (o) => {
...
function Yu(r, e, t = e.terminal) {
  if (t)
    ...
    const n2 = Yl(e.type.ref), i = n2?.terminal;
    if (!i)
...
function am(r) {
  ...
  return zu(e, n2, t.definition), n2.finalize(), n2;
}
function om(r) {
  const e = lm(r);
  return e.finalize(), e;
...
var Qu = class {
  ...
  buildKeywordTokens(e, t, n2) {
    return e.filter(we).flatMap((i) => Mr(i).filter(gt)).distinct((i) => i.value).toArray().sort((i, s) => s.value.length - i.value.length).map((i) => this.buildKeywordToken(i, t, !!n2?.caseInsensitive));
  }
  ...
  findLongerAlt(e, t) {
    return t.reduce((n2, i) => {
      const s = i?.PATTERN;
      return s?.source && Md("^" + s.source + "$", e.value) && n2.push(i), n2;
    }, []);
  }
};
var Ju = class {
...
function ec() {
  if (rl) return ht2;
  rl = 1, Object.defineProperty(ht2, "__esModule", { value: true }), ht2.Emitter = ht2.Event = void 0;
  const r = Zu();
  var e;
  (function(i) {
    const s = { dispose() {
  ...
  return ht2.Emitter = n2, n2._noop = function() {
  }, ht2;
}
var nl;
function cm() {
...
var Hn = /* @__PURE__ */ Symbol("OperationCancelled");
function li(r) {
  return r === Hn;
}
async function $e(r) {
...
(() => {
  var r = { 470: (i) => {
          ...
          if (!(h === g - 1 || m === 1)) if (h !== g - 1 && m === 2) {
            if (d.length < 2 || f !== 2 || d.charCodeAt(d.length - 1) !== 46 || d.charCodeAt(d.length - 2) !== 46) {
              if (d.length > 2) {
                ...
                if (k2 !== d.length - 1) {
                  k2 === -1 ? (d = "", f = 0) : f = (d = d.slice(0, k2)).length - 1 - d.lastIndexOf("/"), h = g, m = 0;
                  continue;
                }
    ...
    var o = { resolve: function() {
      ...
      for (var m = u.length - h, g = f < m ? f : m, k2 = -1, R2 = 0; R2 <= g; ++R2) {
        if (R2 === g) {
          if (m > g) {
            if (u.charCodeAt(h + R2) === 47) return u.slice(h + R2 + 1);
            if (R2 === 0) return u.slice(h + R2);
          } else f > g && (l.charCodeAt(c + R2) === 47 ? k2 = R2 : R2 === 0 && (k2 = 0));
          break;
        }
      ...
      var T = "";
      for (R2 = c + k2 + 1; R2 <= d; ++R2) R2 !== d && l.charCodeAt(R2) !== 47 || (T.length === 0 ? T += ".." : T += "/..");
      return T.length > 0 ? T + u.slice(h + k2) : (h += k2, u.charCodeAt(h) === 47 && ++h, u.slice(h));
      ...
      if (u !== void 0 && u.length > 0 && u.length <= l.length) {
        ...
        for (c = l.length - 1; c >= 0; --c) {
          var k2 = l.charCodeAt(c);
          if (k2 === 47) {
            if (!h) {
              d = c + 1;
              break;
            }
          } else g === -1 && (h = false, g = c + 1), m >= 0 && (k2 === u.charCodeAt(m) ? --m == -1 && (f = c) : (m = -1, f = g));
        }
      ...
      f ? (u.root = "/", c = 1) : c = 0;
      for (var h = -1, m = 0, g = -1, k2 = true, R2 = l.length - 1, $ = 0; R2 >= c; --R2) if ((d = l.charCodeAt(R2)) !== 47) g === -1 && (k2 = false, g = R2 + 1), d === 46 ? h === -1 ? h = R2 : $ !== 1 && ($ = 1) : h !== -1 && ($ = -1);
      else if (!k2) {
        m = R2 + 1;
        break;
      }
  ...
  (() => {
    ...
    function T(E, y) {
      ...
      if (O && (x += O, x += ":"), (b || O === "file") && (x += c, x += c), b) {
        let V = b.indexOf("@");
        if (V !== -1) {
          const ct = b.substr(0, V);
          b = b.substr(V + 1), V = ct.lastIndexOf(":"), V === -1 ? x += S(ct, false, false) : (x += S(ct.substr(0, V), false, false), x += ":", x += S(ct.substr(V + 1), false, true)), x += "@";
        }
        b = b.toLowerCase(), V = b.lastIndexOf(":"), V === -1 ? x += S(b, false, true) : (x += S(b.substr(0, V), false, true), x += b.substr(V));
      }
      if (L) {
        if (L.length >= 3 && L.charCodeAt(0) === 47 && L.charCodeAt(2) === 58) {
          const V = L.charCodeAt(1);
          V >= 65 && V <= 90 && (L = `/${String.fromCharCode(V + 32)}:${L.substr(3)}`);
        } else if (L.length >= 2 && L.charCodeAt(1) === 58) {
          const V = L.charCodeAt(0);
          V >= 65 && V <= 90 && (L = `${String.fromCharCode(V + 32)}:${L.substr(2)}`);
        }
        x += S(L, true, false);
      }
      return Te && (x += "?", x += S(Te, false, false)), Y && (x += "#", x += y ? Y : k2(Y, false, false)), x;
    }
    function I(E) {
      try {
        return decodeURIComponent(E);
      } catch {
        return E.length > 3 ? E.substr(0, 3) + I(E.substr(3)) : E;
      }
    }
    const G = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function ie(E) {
      return E.match(G) ? E.replace(G, (y) => I(y)) : E;
    }
    var Le = t(470);
...
var mm = class {
  ...
  async update(e, t) {
    ...
    return s !== o && (e.parseResult = await this.parseAsync(e.uri, o, t), e.parseResult.value.$document = e), e.state = U2.Parsed, e;
  }
  parse(e, t, n2) {
...
var gm = class {
  ...
  invalidateDocument(e) {
    ...
    return n2 && (this.serviceRegistry.getServices(e).references.Linker.unlink(n2), n2.state = U2.Changed, n2.precomputedScopes = void 0, n2.diagnostics = void 0), n2;
  }
  deleteDocument(e) {
    const t = e.toString(), n2 = this.documentMap.get(t);
    return n2 && (n2.state = U2.Changed, this.documentMap.delete(t)), n2;
  }
};
var Ii = /* @__PURE__ */ Symbol("ref_resolving");
var ym = class {
  constructor(e) {
    ...
    const s = this, a = {
      ...
      get ref() {
        ...
        if (Zc(this._nodeDescription)) {
          ...
          if (u.error && l && l.state < U2.ComputedScopes)
  ...
  createLinkingError(e, t) {
    ...
    n2 && n2.state < U2.ComputedScopes && console.warn(`Attempted reference resolution before document reached ComputedScopes state (${n2.uri}).`);
...
var al = class {
  constructor(e, t, n2) {
    var i;
    this.elements = e, this.outerScope = t, this.caseInsensitive = (i = n2?.caseInsensitive) !== null && i !== void 0 ? i : false;
  }
  getAllElements() {
...
var Em = class {
  constructor(e, t, n2) {
    var i;
    this.elements = /* @__PURE__ */ new Map(), this.caseInsensitive = (i = n2?.caseInsensitive) !== null && i !== void 0 ? i : false;
    for (const s of e) {
...
var Cm = class {
  ...
  serialize(e, t) {
    const n2 = t ?? {}, i = t?.replacer, s = (o, l) => this.replacer(o, l, n2), a = i ? (o, l) => i(o, l, s) : s;
    try {
    ...
    if (!this.ignoreProperties.has(e))
      if (Ge(t)) {
        ...
        if (f) {
          ...
          const k2 = this.astNodeLocator.getAstNodePath(f);
          return {
            $ref: `${g}#${k2}`,
            $refText: h
          };
        ...
        let f;
        if (s && (f = this.addAstNodeRegionWithAssignmentsTo(Object.assign({}, t)), (!e || t.$document) && f?.$textRegion && (f.$textRegion.documentURI = (c = this.currentDocument) === null || c === void 0 ? void 0 : c.uri.toString())), i && !e && (f ?? (f = Object.assign({}, t)), f.$sourceText = (d = t.$cstNode) === null || d === void 0 ? void 0 : d.text), a) {
          f ?? (f = Object.assign({}, t));
...
var Um = class {
        ...
        if (typeof t.validation == "boolean" && t.validation)
          ...
          if (u) {
            ...
            c.length > 0 && (this.buildState.set(o, {
              ...
              result: l.result
            }), a.state = U2.IndexedReferences);
          }
        }
      } else
        this.buildState.delete(o);
    }
    this.currentState = U2.Changed, await this.emitUpdate(e.map((a) => a.uri), []), await this.buildDocuments(e, t, n2);
  }
  async update(e, t, n2 = K.CancellationToken.None) {
    this.currentState = U2.Changed;
    for (const a of t)
    ...
    for (const a of e) {
      if (!this.langiumDocuments.invalidateDocument(a)) {
        ...
        o.state = U2.Changed, this.langiumDocuments.addDocument(o);
      }
    ...
    this.langiumDocuments.all.filter((a) => !i.has(a.uri.toString()) && this.shouldRelink(a, i)).forEach((a) => {
      this.serviceRegistry.getServices(a.uri).references.Linker.unlink(a), a.state = Math.min(a.state, U2.ComputedScopes), a.diagnostics = void 0;
    }), await this.emitUpdate(e, t), await $e(n2);
    const s = this.sortDocuments(this.langiumDocuments.all.filter((a) => {
      var o;
      return a.state < U2.Linked || !(!((o = this.buildState.get(a.uri.toString())) === null || o === void 0) && o.completed);
    }).toArray());
  ...
  async buildDocuments(e, t, n2) {
    this.prepareBuild(e, t), await this.runCancelable(e, U2.Parsed, n2, (s) => this.langiumDocumentFactory.update(s, n2)), await this.runCancelable(e, U2.IndexedContent, n2, (s) => this.indexManager.updateContent(s, n2)), await this.runCancelable(e, U2.ComputedScopes, n2, async (s) => {
    ...
    }), await this.runCancelable(e, U2.Linked, n2, (s) => this.serviceRegistry.getServices(s.uri).references.Linker.link(s, n2)), await this.runCancelable(e, U2.IndexedReferences, n2, (s) => this.indexManager.updateReferences(s, n2));
    const i = e.filter((s) => this.shouldValidate(s));
    await this.runCancelable(i, U2.Validated, n2, (s) => this.validate(s, n2));
    for (const s of e) {
  ...
  async validate(e, t) {
    ...
    if (u) {
      ...
      const c = (i = o?.categories) !== null && i !== void 0 ? i : zn.all;
...
function qm(r) {
  ...
  for (let o = 0; o < r.lines.length; o++) {
    ...
    if (c = c.substring(0, Zm(c)), Ms(c, d) >= c.length) {
      ...
      const f = ul.exec(c);
      if (f) {
        const h = f[0], m = f[1], g = P.create(s, a + d), k2 = P.create(s, a + d + h.length);
        i.push({
          type: "tag",
          content: m,
          range: _.create(g, k2)
...
${t}`), this.inline ? `{${e}}` : e;
  ...
  toMarkdown(e) {
    var t, n2;
    return (n2 = (t = e?.renderTag) === null || t === void 0 ? void 0 : t.call(e, this)) !== null && n2 !== void 0 ? n2 : this.toMarkdownDefault(e);
  }
  toMarkdownDefault(e) {
    ...
    let n2 = "";
    e?.tag === "italic" || e?.tag === void 0 ? n2 = "*" : e?.tag === "bold" ? n2 = "**" : e?.tag === "bold-italic" && (n2 = "***");
...
function ig(r, e, t) {
  ...
  if (r === "linkplain" || r === "linkcode" || r === "link") {
    ...
    return (r === "linkcode" || r === "link" && t.link === "code") && (a = `\`${a}\``), (i = (n2 = t.renderLink) === null || n2 === void 0 ? void 0 : n2.call(t, e, a)) !== null && i !== void 0 ? i : sg(e, a);
  }
}
function sg(r, e) {
  try {
...
var dg = /* @__PURE__ */ Symbol("isProxy");
function dc(r, e) {
  const t = new Proxy({}, {
...
var Ry2 = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/;
var Zi;
...
var xy = {
  info: v(async () => {
    const { createInfoServices: r } = await import("./info-63CPKGFF-DZeTg6Sj-2H-Js7bO-DBQHYNSD.js"), e = r().Info.parser.LangiumParser;
    He.info = e;
  }, "info"),
  packet: v(async () => {
    const { createPacketServices: r } = await import("./packet-HUATNLJX-98_D1O5E-lCMid0MW-YU5RVGUK.js"), e = r().Packet.parser.LangiumParser;
    He.packet = e;
  }, "packet"),
  pie: v(async () => {
    const { createPieServices: r } = await import("./pie-WTHONI2E-D337kPVJ-uvMJ4q_7-BHF2FSIW.js"), e = r().Pie.parser.LangiumParser;
    He.pie = e;
  }, "pie"),
  architecture: v(async () => {
    const { createArchitectureServices: r } = await import("./architecture-O4VJ6CD3-cxLk0nJU-YfeZhH_I-7QRO6ZFT.js"), e = r().Architecture.parser.LangiumParser;
    He.architecture = e;
  }, "architecture"),
  gitGraph: v(async () => {
    const { createGitGraphServices: r } = await import("./gitGraph-ZV4HHKMB-CLarli0n-CzbwP12_-RPAK22EF.js"), e = r().GitGraph.parser.LangiumParser;
    He.gitGraph = e;
  }, "gitGraph"),
  radar: v(async () => {
    const { createRadarServices: r } = await import("./radar-NJJJXTRR-CqNCNvUs-W0OxF_C--UDBCUSIO.js"), e = r().Radar.parser.LangiumParser;
    He.radar = e;
  }, "radar"),
  treemap: v(async () => {
    const { createTreemapServices: r } = await import("./treemap-75Q7IDZK-CjtfQE8u-CpNGz5UP-2NZZ5UMX.js"), e = r().Treemap.parser.LangiumParser;
    He.treemap = e;
  }, "treemap")
};
...
//# sourceMappingURL=chunk-SGMUMMDM.js.map
