...
// node_modules/vitepress-plugin-legend/dist/architectureDiagram-SUXI7LT5-MkMpV-jr-C80n97YT.js
var fe = { exports: {} };
var pe = { exports: {} };
var ve = { exports: {} };
var ui = ve.exports;
      ...
      return (
        ...
        (function(_) {
          ...
          function T(u) {
            ...
            return _[u].call(d.exports, d, d.exports, T), d.l = true, d.exports;
          }
          return T.m = _, T.c = k, T.i = function(u) {
            return u;
          }, T.d = function(u, d, o) {
          ...
          function(_, k, T) {
            ...
            function n(t, a, l, g) {
              l == null && g == null && (g = a), u.call(this, g), t.graphManager != null && (t = t.graphManager), this.estimatedSize = d.MIN_VALUE, this.inclusionTreeDepth = d.MAX_VALUE, this.vGraphObject = g, this.edges = [], this.graphManager = t, l != null && a != null ? this.rect = new o(a.x, a.y, l.width, l.height) : this.rect = new o();
            }
            ...
            n.prototype.getEdges = function() {
              ...
              var a = [], l = this;
              return l.edges.forEach(function(g) {
                if (g.target == t) {
                  if (g.source != l) throw "Incorrect edge source!";
                  a.push(g);
                }
              }), a;
              ...
              var a = [], l = this;
              return l.edges.forEach(function(g) {
                if (!(g.source == l || g.target == l)) throw "Incorrect edge source and/or target";
                (g.target == t || g.source == t) && a.push(g);
              }), a;
              ...
              if (t.add(this), this.child != null)
                for (var g = this.child.getNodes(), h = 0; h < g.length; h++)
                  a = g[h], l = a.withChildren(), l.forEach(function(N) {
                    t.add(N);
                  });
              return t;
              ...
              if (this.child == null)
                ...
                for (var l = this.child.getNodes(), g = 0; g < l.length; g++)
                  a = l[g], t += a.getNoOfChildren();
              return t == 0 && (t = 1), t;
              ...
              var t, a, l = -i2.INITIAL_WORLD_BOUNDARY, g = i2.INITIAL_WORLD_BOUNDARY;
              t = i2.WORLD_CENTER_X + e2.nextDouble() * (g - l) + l;
              ...
              var g = new s(a, l), h = t.inverseTransformPoint(g);
          ...
          function(_, k, T) {
            ...
            function a(g, h, N) {
              u.call(this, N), this.estimatedSize = d.MIN_VALUE, this.margin = o.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = g, h != null && h instanceof i2 ? this.graphManager = h : h != null && h instanceof Layout && (this.graphManager = h.graphManager);
            }
            ...
            a.prototype.getNodes = function() {
            ...
            }, a.prototype.add = function(g, h, N) {
              if (h == null && N == null) {
                var c = g;
              ...
              if (g instanceof e2) {
                ...
                for (var N = h.edges.slice(), c, y = N.length, A = 0; A < y; A++)
                  c = N[A], c.isInterGraph ? this.graphManager.remove(c) : c.source.owner.remove(c);
                ...
                var P = c.source.edges.indexOf(c), Y = c.target.edges.indexOf(c);
                if (!(P > -1 && Y > -1))
                  throw "Source and/or target doesn't know this edge!";
                c.source.edges.splice(P, 1), c.target != c.source && c.target.edges.splice(Y, 1);
              ...
              for (var g = d.MAX_VALUE, h = d.MAX_VALUE, N, c, y, A = this.getNodes(), I = A.length, P = 0; P < I; P++) {
                var Y = A[P];
                N = Y.getTop(), c = Y.getLeft(), g > N && (g = N), h > c && (h = c);
              }
              return g == d.MAX_VALUE ? null : (A[0].getParent().paddingLeft != null ? y = A[0].getParent().paddingLeft : y = this.margin, this.left = h - y, this.top = g - y, new f(this.left, this.top));
            }, a.prototype.updateBounds = function(g) {
              for (var h = d.MAX_VALUE, N = -d.MAX_VALUE, c = d.MAX_VALUE, y = -d.MAX_VALUE, A, I, P, Y, S, H = this.nodes, Z = H.length, x = 0; x < Z; x++) {
                var ot = H[x];
                g && ot.child != null && ot.updateBounds(), A = ot.getLeft(), I = ot.getRight(), P = ot.getTop(), Y = ot.getBottom(), h > A && (h = A), N < I && (N = I), c > P && (c = P), y < Y && (y = Y);
              }
              var r = new n(h, c, N - h, y - c);
            ...
            }, a.calculateBounds = function(g) {
              for (var h = d.MAX_VALUE, N = -d.MAX_VALUE, c = d.MAX_VALUE, y = -d.MAX_VALUE, A, I, P, Y, S = g.length, H = 0; H < S; H++) {
                var Z = g[H];
                A = Z.getLeft(), I = Z.getRight(), P = Z.getTop(), Y = Z.getBottom(), h > A && (h = A), N < I && (N = I), c > P && (c = P), y < Y && (y = Y);
              }
              var x = new n(h, c, N - h, y - c);
              return x;
              ...
              for (var g = 0, h = this.nodes, N = h.length, c = 0; c < N; c++) {
                var y = h[c];
              ...
              var h = new t(), N = /* @__PURE__ */ new Set(), c = this.nodes[0], y, A, I = c.withChildren();
              for (I.forEach(function(x) {
                h.push(x), N.add(x);
              }); h.length !== 0; ) {
                c = h.shift(), y = c.getEdges();
                for (var P = y.length, Y = 0; Y < P; Y++) {
                  var S = y[Y];
                  if (A = S.getOtherEndInGraph(c, this), A != null && !N.has(A)) {
          ...
          function(_, k, T) {
            ...
            o.prototype.addRoot = function() {
              ...
              if (i2 instanceof u) {
                ...
                var g = this.graphs.indexOf(e2);
                this.graphs.splice(g, 1), e2.parent = null;
                ...
                if (!(n.source.edges.indexOf(n) != -1 && n.target.edges.indexOf(n) != -1))
                  throw "Source and/or target doesn't know this edge!";
                var g = n.source.edges.indexOf(n);
                if (n.source.edges.splice(g, 1), g = n.target.edges.indexOf(n), n.target.edges.splice(g, 1), !(n.source.owner != null && n.source.owner.getGraphManager() != null))
                  throw "Edge owner graph or owner graph manager is null!";
                if (n.source.owner.getGraphManager().edges.indexOf(n) == -1)
                  throw "Not in owner graph manager's edge list!";
                var g = n.source.owner.getGraphManager().edges.indexOf(n);
                n.source.owner.getGraphManager().edges.splice(g, 1);
              }
          ...
          function(_, k, T) {
            ...
            d.calcSeparationAmount = function(o, i2, e2, s) {
              ...
              var a = o.getX(), l = o.getY(), g = o.getRight(), h = o.getX(), N = o.getBottom(), c = o.getRight(), y = o.getWidthHalf(), A = o.getHeightHalf(), I = i2.getX(), P = i2.getY(), Y = i2.getRight(), S = i2.getX(), H = i2.getBottom(), Z = i2.getRight(), x = i2.getWidthHalf(), ot = i2.getHeightHalf(), r = false, E = false;
              if (s === f) {
                if (n > t)
                ...
                if (s < f)
                  return e2[0] = g, e2[1] = n, e2[2] = I, e2[3] = t, false;
              } else {
                var p = o.height / o.width, v = i2.height / i2.width, m = (t - n) / (f - s), O = void 0, M = void 0, C = void 0, F2 = void 0, U = void 0, z = void 0;
                if (-p === m ? s > f ? (e2[0] = h, e2[1] = N, r = true) : (e2[0] = g, e2[1] = l, r = true) : p === m && (s > f ? (e2[0] = a, e2[1] = l, r = true) : (e2[0] = c, e2[1] = N, r = true)), -v === m ? f > s ? (e2[2] = S, e2[3] = H, E = true) : (e2[2] = Y, e2[3] = P, E = true) : v === m && (f > s ? (e2[2] = I, e2[3] = P, E = true) : (e2[2] = Z, e2[3] = H, E = true)), r && E)
                  return false;
                if (s > f ? n > t ? (O = this.getCardinalDirection(p, m, 4), M = this.getCardinalDirection(v, m, 2)) : (O = this.getCardinalDirection(-p, m, 3), M = this.getCardinalDirection(-v, m, 1)) : n > t ? (O = this.getCardinalDirection(-p, m, 1), M = this.getCardinalDirection(-v, m, 3)) : (O = this.getCardinalDirection(p, m, 2), M = this.getCardinalDirection(v, m, 4)), !r)
                  switch (O) {
                    case 1:
                      F2 = l, C = s + -A / m, e2[0] = C, e2[1] = F2;
                      break;
                    case 2:
                      C = c, F2 = n + y * m, e2[0] = C, e2[1] = F2;
                      break;
                    case 3:
                      F2 = N, C = s + A / m, e2[0] = C, e2[1] = F2;
                      break;
                    case 4:
                      C = h, F2 = n + -y * m, e2[0] = C, e2[1] = F2;
                      break;
                  }
                if (!E)
                  switch (M) {
              ...
              var n = o.x, f = o.y, t = i2.x, a = i2.y, l = e2.x, g = e2.y, h = s.x, N = s.y, c = void 0, y = void 0, A = void 0, I = void 0, P = void 0, Y = void 0, S = void 0, H = void 0, Z = void 0;
              return A = a - f, P = n - t, S = t * f - n * a, I = N - g, Y = l - h, H = h * g - l * N, Z = A * Y - I * P, Z === 0 ? null : (c = (P * H - Y * S) / Z, y = (I * S - A * H) / Z, new u(c, y));
              ...
              var n = o.x, f = o.y, t = i2.x, a = i2.y, l = e2.x, g = e2.y, h = s.x, N = s.y, c = (t - n) * (N - g) - (h - l) * (a - f);
              if (c === 0)
                return false;
              var y = ((N - g) * (h - n) + (l - h) * (N - f)) / c, A = ((f - a) * (h - n) + (t - n) * (N - f)) / c;
              return 0 < y && y < 1 && 0 < A && A < 1;
            }, d.findCircleLineIntersections = function(o, i2, e2, s, n, f, t) {
              var a = (e2 - o) * (e2 - o) + (s - i2) * (s - i2), l = 2 * ((o - n) * (e2 - o) + (i2 - f) * (s - i2)), g = (o - n) * (o - n) + (i2 - f) * (i2 - f) - t * t, h = l * l - 4 * a * g;
              if (h >= 0) {
                var N = (-l + Math.sqrt(l * l - 4 * a * g)) / (2 * a), c = (-l - Math.sqrt(l * l - 4 * a * g)) / (2 * a), y = null;
                return N >= 0 && N <= 1 ? [N] : c >= 0 && c <= 1 ? [c] : y;
              } else return null;
            }, d.HALF_PI = 0.5 * Math.PI, d.ONE_AND_HALF_PI = 1.5 * Math.PI, d.TWO_PI = 2 * Math.PI, d.THREE_PI = 3 * Math.PI, _.exports = d;
          },
          /* 9 */
          /***/
          function(_, k, T) {
          ...
          function(_, k, T) {
            ...
            u.MAX_VALUE = 2147483647, u.MIN_VALUE = -2147483648, _.exports = u;
          },
          /* 11 */
          /***/
          function(_, k, T) {
            ...
            var o = function(n) {
              ...
              function n(f) {
                var t = this;
                d(this, n), this.length = 0, this.head = null, this.tail = null, f?.forEach(function(a) {
                  return t.push(a);
                });
              }
              return u(n, [{
          ...
          function(_, k, T) {
            function u(l) {
              if (Array.isArray(l)) {
                for (var g = 0, h = Array(l.length); g < l.length; g++)
                  h[g] = l[g];
                return h;
              } else
                return Array.from(l);
            ...
            a.RANDOM_SEED = 1, a.prototype = Object.create(t.prototype), a.prototype.getGraphManager = function() {
              ...
              if (this.createBendsAsNeeded && (this.createBendpointsFromDummyNodes(), this.graphManager.resetAllEdges()), !this.isRemoteUse) {
                for (var l = this.graphManager.getAllEdges(), g = 0; g < l.length; g++)
                  l[g];
                for (var h = this.graphManager.getRoot().getNodes(), g = 0; g < h.length; g++)
                  h[g];
              ...
              if (l == null)
                ...
                var g = l;
                if (g.getChild() != null)
                  for (var h = g.getChild().getNodes(), N = 0; N < h.length; N++)
                    update(h[N]);
                if (g.vGraphObject != null) {
                  var c = g.vGraphObject;
                  c.update(g);
                }
              ...
              if (l == null)
                ...
                var g = new f(), h = this.graphManager.getRoot().updateLeftTop();
                if (h != null) {
                  g.setWorldOrgX(l.x), g.setWorldOrgY(l.y), g.setDeviceOrgX(h.x), g.setDeviceOrgY(h.y);
                  for (var N = this.getAllNodes(), c, y = 0; y < N.length; y++)
                    c = N[y], c.transform(g);
                }
              }
              ...
              if (l == null)
                ...
                for (var g, h, N = l.getNodes(), c = 0; c < N.length; c++)
                  g = N[c], h = g.getChild(), h == null || h.getNodes().length == 0 ? g.scatter() : (this.positionNodesRandomly(h), g.updateBounds());
            }, a.prototype.getFlatForest = function() {
              for (var l = [], g = true, h = this.graphManager.getRoot().getNodes(), N = true, c = 0; c < h.length; c++)
                h[c].getChild() != null && (N = false);
              if (!N)
                return l;
              var y = /* @__PURE__ */ new Set(), A = [], I = /* @__PURE__ */ new Map(), P = [];
              for (P = P.concat(h); P.length > 0 && g; ) {
                for (A.push(P[0]); A.length > 0 && g; ) {
                  var Y = A[0];
                  A.splice(0, 1), y.add(Y);
                  for (var S = Y.getEdges(), c = 0; c < S.length; c++) {
                    var H = S[c].getOtherEnd(Y);
                    if (I.get(Y) != H)
                      if (!y.has(H))
                        A.push(H), I.set(H, Y);
                      else {
              ...
              for (var g = [], h = l.source, N = this.graphManager.calcLowestCommonAncestor(l.source, l.target), c = 0; c < l.bendpoints.length; c++) {
                var y = this.newNode(null);
                y.setRect(new Point(0, 0), new Dimension(1, 1)), N.add(y);
                var A = this.newEdge(null);
                this.graphManager.add(A, h, y), g.add(y), h = y;
              }
              var A = this.newEdge(null);
              return this.graphManager.add(A, h, l.target), this.edgeToDummyNodes.set(l, g), l.isInterGraph() ? this.graphManager.remove(l) : N.remove(l), g;
              ...
              for (var g = 0; g < l.length; g++) {
                ...
                if (h.bendpoints.length > 0) {
                  for (var N = this.edgeToDummyNodes.get(h), c = 0; c < N.length; c++) {
                    var y = N[c], A = new n(y.getCenterX(), y.getCenterY()), I = h.bendpoints.get(c);
                    I.x = A.x, I.y = A.y, y.getOwner().remove(y);
                  }
                  this.graphManager.add(h, h.source, h.target);
                }
              }
            }, a.transform = function(l, g, h, N) {
              if (h != null && N != null) {
                var c = g;
                if (l <= 50) {
                  var y = g / h;
                ...
                var I, P;
                return l <= 50 ? (I = 9 * g / 500, P = g / 10) : (I = 9 * g / 50, P = -8 * g), I * l + P;
              }
            }, a.findCenterOfTree = function(l) {
              var g = [];
              g = g.concat(l);
              var h = [], N = /* @__PURE__ */ new Map(), c = false, y = null;
              (g.length == 1 || g.length == 2) && (c = true, y = g[0]);
              for (var A = 0; A < g.length; A++) {
                var I = g[A], P = I.getNeighborsList().size;
              ...
              for (Y = Y.concat(h); !c; ) {
                ...
                h = h.concat(Y), (g.length == 1 || g.length == 2) && (c = true, y = g[0]);
              }
              return y;
          ...
          function(_, k, T) {
            ...
            n.prototype.initParameters = function() {
              ...
              for (var t, a, l, g, h, N, c, y = this.getGraphManager().getAllEdges(), A = 0; A < y.length; A++)
                t = y[A], a = t.idealLength, t.isInterGraph && (g = t.getSource(), h = t.getTarget(), N = t.getSourceInLca().getEstimatedSize(), c = t.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (t.idealLength += N + c - 2 * i2.SIMPLE_NODE_SIZE), l = t.getLca().getInclusionTreeDepth(), t.idealLength += a * o.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (g.getInclusionTreeDepth() + h.getInclusionTreeDepth() - 2 * l));
              ...
              var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, l, g, h, N, c = this.getAllNodes(), y;
              if (this.useFRGridVariant)
                for (this.totalIterations % o.GRID_CALCULATION_CHECK_PERIOD == 1 && t && this.updateGrid(), y = /* @__PURE__ */ new Set(), l = 0; l < c.length; l++)
                  h = c[l], this.calculateRepulsionForceOfANode(h, y, t, a), y.add(h);
              else
                for (l = 0; l < c.length; l++)
                  for (h = c[l], g = l + 1; g < c.length; g++)
                    N = c[g], h.getOwner() == N.getOwner() && this.calcRepulsionForce(h, N);
              ...
              var l = t.getSource(), g = t.getTarget(), h, N, c, y;
              if (this.uniformLeafNodeSizes && l.getChild() == null && g.getChild() == null)
                t.updateLengthSimple();
              else if (t.updateLength(), t.isOverlapingSourceAndTarget)
                return;
              h = t.getLength(), h != 0 && (N = t.edgeElasticity * (h - a), c = N * (t.lengthX / h), y = N * (t.lengthY / h), l.springForceX += c, l.springForceY += y, g.springForceX -= c, g.springForceY -= y);
            }, n.prototype.calcRepulsionForce = function(t, a) {
              var l = t.getRect(), g = a.getRect(), h = new Array(2), N = new Array(4), c, y, A, I, P, Y, S;
              if (l.intersects(g)) {
                e2.calcSeparationAmount(l, g, h, o.DEFAULT_EDGE_LENGTH / 2), Y = 2 * h[0], S = 2 * h[1];
                ...
                this.uniformLeafNodeSizes && t.getChild() == null && a.getChild() == null ? (c = g.getCenterX() - l.getCenterX(), y = g.getCenterY() - l.getCenterY()) : (e2.getIntersection(l, g, N), c = N[2] - N[0], y = N[3] - N[1]), Math.abs(c) < o.MIN_REPULSION_DIST && (c = s.sign(c) * o.MIN_REPULSION_DIST), Math.abs(y) < o.MIN_REPULSION_DIST && (y = s.sign(y) * o.MIN_REPULSION_DIST), A = c * c + y * y, I = Math.sqrt(A), P = (t.nodeRepulsion / 2 + a.nodeRepulsion / 2) * t.noOfChildren * a.noOfChildren / A, Y = P * c / I, S = P * y / I, t.repulsionForceX -= Y, t.repulsionForceY -= S, a.repulsionForceX += Y, a.repulsionForceY += S;
            }, n.prototype.calcGravitationalForce = function(t) {
              var a, l, g, h, N, c, y, A;
              a = t.getOwner(), l = (a.getRight() + a.getLeft()) / 2, g = (a.getTop() + a.getBottom()) / 2, h = t.getCenterX() - l, N = t.getCenterY() - g, c = Math.abs(h) + t.getWidth() / 2, y = Math.abs(N) + t.getHeight() / 2, t.getOwner() == this.graphManager.getRoot() ? (A = a.getEstimatedSize() * this.gravityRangeFactor, (c > A || y > A) && (t.gravitationForceX = -this.gravityConstant * h, t.gravitationForceY = -this.gravityConstant * N)) : (A = a.getEstimatedSize() * this.compoundGravityRangeFactor, (c > A || y > A) && (t.gravitationForceX = -this.gravityConstant * h * this.compoundGravityConstant, t.gravitationForceY = -this.gravityConstant * N * this.compoundGravityConstant));
              ...
              for (var g = new Array(a), h = 0; h < a; h++)
                g[h] = new Array(l);
              for (var h = 0; h < a; h++)
                for (var N = 0; N < l; N++)
                  g[h][N] = new Array();
              ...
              var g = 0, h = 0, N = 0, c = 0;
              g = parseInt(Math.floor((t.getRect().x - a) / this.repulsionRange)), h = parseInt(Math.floor((t.getRect().width + t.getRect().x - a) / this.repulsionRange)), N = parseInt(Math.floor((t.getRect().y - l) / this.repulsionRange)), c = parseInt(Math.floor((t.getRect().height + t.getRect().y - l) / this.repulsionRange));
              for (var y = g; y <= h; y++)
                for (var A = N; A <= c; A++)
                  this.grid[y][A].push(t), t.setGridCoordinates(g, h, N, c);
            ...
            }, n.prototype.calculateRepulsionForceOfANode = function(t, a, l, g) {
              if (this.totalIterations % o.GRID_CALCULATION_CHECK_PERIOD == 1 && l || g) {
                var h = /* @__PURE__ */ new Set();
                t.surrounding = new Array();
                for (var N, c = this.grid, y = t.startX - 1; y < t.finishX + 2; y++)
                  for (var A = t.startY - 1; A < t.finishY + 2; A++)
                    if (!(y < 0 || A < 0 || y >= c.length || A >= c[0].length)) {
                      for (var I = 0; I < c[y][A].length; I++)
                        if (N = c[y][A][I], !(t.getOwner() != N.getOwner() || t == N) && !a.has(N) && !h.has(N)) {
          ...
          function(_, k, T) {
            ...
            u.multMat = function(d, o) {
              ...
              for (var l = 0; l < i2.length; l++) {
                for (var g = 0, h = 0; h < i2.length; h++)
                  g += i2[l][h] * s[h];
                n[l] = g;
              }
              for (var N = 0; N < o.length; N++) {
                for (var c = 0, y = 0; y < o[0].length; y++)
                  c += o[N][y] * n[y];
                e2[N] = c;
              }
              return e2;
            ...
            u.svd = function(d) {
              ...
              n < this.n && (this.s[n] = d[n][n]), this.m < r && (this.s[r - 1] = 0), f + 1 < r && (i2[f] = d[f][r - 1]), i2[r - 1] = 0;
              {
                ...
                for (var v = n - 1; v >= 0; v--)
                  if (this.s[v] !== 0) {
                    ...
                    for (var F2 = v; F2 < this.m; F2++)
                      this.U[F2][v] = -this.U[F2][v];
              ...
              for (var q = r - 1, et = Math.pow(2, -52), vt = Math.pow(2, -966); r > 0; ) {
                ...
                switch (j++, Dt) {
                  case 1:
                    {
                      ...
                      for (var ht = r - 2; ht >= j; ht--) {
                        var _t = u.hypot(this.s[ht], mt), Mt = this.s[ht] / _t, Tt2 = mt / _t;
                        this.s[ht] = _t, ht !== j && (mt = -Tt2 * i2[ht - 1], i2[ht - 1] = Mt * i2[ht - 1]);
                        for (var wt = 0; wt < this.n; wt++)
                          _t = Mt * this.V[wt][ht] + Tt2 * this.V[wt][r - 1], this.V[wt][r - 1] = -Tt2 * this.V[wt][ht] + Mt * this.V[wt][r - 1], this.V[wt][ht] = _t;
                      }
                    }
                    break;
                  case 2:
                  ...
                  case 3:
                    {
                      var jt = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[r - 1]), Math.abs(this.s[r - 2])), Math.abs(i2[r - 2])), Math.abs(this.s[j])), Math.abs(i2[j])), ct = this.s[r - 1] / jt, L = this.s[r - 2] / jt, R = i2[r - 2] / jt, V = this.s[j] / jt, Q = i2[j] / jt, K = ((L + ct) * (L - ct) + R * R) / 2, pt = ct * R * (ct * R), lt = 0;
                      /* @__PURE__ */ (function(Lt, At) {
                        return Lt || At;
                      })(K !== 0, pt !== 0) && (lt = Math.sqrt(K * K + pt), K < 0 && (lt = -lt), lt = pt / (K + lt));
                      for (var tt = (V + ct) * (V - ct) + lt, gt = V * Q, rt = j; rt < r - 1; rt++) {
                        var Nt = u.hypot(tt, gt), yt = tt / Nt, Ct = gt / Nt;
                        rt !== j && (i2[rt - 1] = Nt), tt = yt * this.s[rt] + Ct * i2[rt], i2[rt] = yt * i2[rt] - Ct * this.s[rt], gt = Ct * this.s[rt + 1], this.s[rt + 1] = yt * this.s[rt + 1];
                        ...
                        if (Nt = u.hypot(tt, gt), yt = tt / Nt, Ct = gt / Nt, this.s[rt] = Nt, tt = yt * i2[rt] + Ct * this.s[rt + 1], this.s[rt + 1] = -Ct * i2[rt] + yt * this.s[rt + 1], gt = Ct * i2[rt + 1], i2[rt + 1] = yt * i2[rt + 1], rt < this.m - 1)
                      ...
                      for (; j < q && !(this.s[j] >= this.s[j + 1]); ) {
                        ...
                        if (this.s[j] = this.s[j + 1], this.s[j + 1] = It, j < this.n - 1)
                          for (var ut = 0; ut < this.n; ut++)
                            It = this.V[ut][j + 1], this.V[ut][j + 1] = this.V[ut][j], this.V[ut][j] = It;
                        if (j < this.m - 1)
              ...
              function i2(e2, s) {
                ...
                for (var g = 0; g < this.iMax; g++) {
                  ...
                  for (var h = 0; h < this.jMax; h++)
                    this.tracebackGrid[g][h] = [null, null, null];
                }
                ...
                value: function() {
                  ...
                  for (var n = 1; n < this.iMax; n++)
                    for (var f = 1; f < this.jMax; f++) {
                      ...
                      var a = this.grid[n - 1][f] + this.gap_penalty, l = this.grid[n][f - 1] + this.gap_penalty, g = [t, a, l], h = this.arrayAllMaxIndexes(g);
                      this.grid[n][f] = g[h[0]], this.tracebackGrid[n][f] = [h.includes(0), h.includes(1), h.includes(2)];
                    }
        ...
        (() => {
          var k = {
            ...
            765: (
              /***/
              ((o, i2, e2) => {
                var s = e2(551).FDLayout, n = e2(578), f = e2(880), t = e2(991), a = e2(767), l = e2(806), g = e2(902), h = e2(551).FDLayoutConstants, N = e2(551).LayoutConstants, c = e2(551).Point, y = e2(551).PointD, A = e2(551).DimensionD, I = e2(551).Layout, P = e2(551).Integer, Y = e2(551).IGeometry, S = e2(551).LGraph, H = e2(551).Transform, Z = e2(551).LinkedList;
                function x() {
                ...
                x.prototype.newGraphManager = function() {
                  ...
                  return Object.keys(this.constraints).length > 0 && (g.handleConstraints(this), this.initConstraintVariables()), this.initSpringEmbedder(), l.APPLY_LAYOUT && this.runSpringEmbedder(), true;
                  ...
                  if (this.constraints.relativePlacementConstraint) {
                    ...
                    if (this.dummyToNodeForVerticalAlignment = /* @__PURE__ */ new Map(), this.dummyToNodeForHorizontalAlignment = /* @__PURE__ */ new Map(), this.fixedNodesOnHorizontal = /* @__PURE__ */ new Set(), this.fixedNodesOnVertical = /* @__PURE__ */ new Set(), this.fixedNodeSet.forEach(function(D) {
                      ...
                      if (this.constraints.alignmentConstraint.vertical)
                        for (var F2 = this.constraints.alignmentConstraint.vertical, p = 0; p < F2.length; p++)
                          this.dummyToNodeForVerticalAlignment.set("dummy" + p, []), F2[p].forEach(function(b) {
                  ...
                  if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function(G) {
                    ...
                    if (this.constraints.alignmentConstraint.horizontal)
                      for (var M = this.constraints.alignmentConstraint.horizontal, p = 0; p < M.length; p++) {
                        ...
                        for (var F2 = C / M[p].length, m = 0; m < M[p].length; m++)
                          this.idToNodeMap.get(M[p][m]).displacementY = F2;
                      }
                  }
                  if (this.constraints.relativePlacementConstraint)
                    if (l.RELAX_MOVEMENT_ON_CONSTRAINTS)
                        ...
                        if (M = M.concat(m.getEdgeListToNode(O)), M = M.concat(O.getEdgeListToNode(m)), !E.has(M[0])) {
                          if (M.length > 1) {
                            ...
                            for (C = 0; C < M.length; C++) {
                              var F2 = M[C];
                              F2.getBendpoints().push(new y()), this.createDummyNodesForBendpoints(F2);
                            }
                          }
                  ...
                  for (var E = new c(0, 0), p = Math.ceil(Math.sqrt(r.length)), v = 0, m = 0, O = 0, M = new y(0, 0), C = 0; C < r.length; C++) {
                    C % p == 0 && (O = 0, m = v, C != 0 && (m += l.DEFAULT_COMPONENT_SEPERATION), v = 0);
                    var F2 = r[C], U = I.findCenterOfTree(F2);
                    E.x = O, E.y = m, M = x.radialLayout(F2, U, E), M.y > v && (v = Math.floor(M.y)), O = Math.floor(M.x + l.DEFAULT_COMPONENT_SEPERATION);
                  }
                  ...
                  var F2 = new y(m.getMaxX(), m.getMaxY());
                  return O.inverseTransformPoint(F2);
                }, x.branchRadialLayout = function(r, E, p, v, m, O) {
                  var M = (v - p + 1) / 2;
                  M < 0 && (M += 180);
                  var C = (M + p) % 360, F2 = C * Y.TWO_PI / 360, U = m * Math.cos(F2), z = m * Math.sin(F2);
                  r.setCenter(U, z);
                  var W = [];
                  ...
                  Object.keys(E).forEach(function(F2) {
                    if (E[F2].length > 1) {
                      var U = "DummyCompound_" + F2;
                      r.memberGroups[U] = E[F2];
                      var z = E[F2][0].getParent(), W = new t(r.graphManager);
                  ...
                  E += v + O, p += m + M;
                  for (var C = E, F2 = 0; F2 < r.rows.length; F2++) {
                    var U = r.rows[F2];
                    E = C;
                  ...
                  var F2 = O / m, U = M / m, z = Math.pow(p - v, 2) + 4 * (F2 + v) * (U + p) * m, W = (v - p + Math.sqrt(z)) / (2 * (F2 + v)), B;
                  ...
                  var F2 = 0;
                  C > r.rowHeight[p] && (F2 = r.rowHeight[p], r.rowHeight[p] = C, F2 = r.rowHeight[p] - F2), r.height += F2, r.rows[p].push(E);
                  ...
                  var F2;
                  r.width - M >= E + r.horizontalPadding ? F2 = (r.height + C) / (M + E + r.horizontalPadding) : F2 = (r.height + C) / r.width, C = p + r.verticalPadding;
                  var U;
                  return r.width < E ? U = (r.height + C) / E : U = (r.height + C) / r.width, U < 1 && (U = 1 / U), F2 < 1 && (F2 = 1 / F2), F2 < U;
                  ...
                  if (r.width - r.rowWidth[p] > O && E != p) {
                    ...
                    var F2 = r.rowHeight[E] + r.rowHeight[p];
                    ...
                    r.height += U - F2, this.shiftToLastRow(r);
                  }
                  ...
                  for (var r = [], E = true, p; E; ) {
                    ...
                    if (E == true) {
                      for (var F2 = [], U = 0; U < m.length; U++)
                        m[U][0].getEdges().length == 1 && (F2.push(m[U]), m[U][0].getOwner().remove(m[U][0]));
                      r.push(F2), this.graphManager.resetAllNodes(), this.graphManager.resetAllEdges();
                    }
                  }
                  ...
                  if (v == r[1].source ? p = r[1].target : p = r[1].source, l.PURE_INCREMENTAL)
                    ...
                    var m = p.startX, O = p.finishX, M = p.startY, C = p.finishY, F2 = 0, U = 0, z = 0, W = 0, B = [F2, z, U, W];
                    if (M > 0)
                      for (var $ = m; $ <= O; $++)
            ...
            991: (
              ...
              ((o, i2, e2) => {
                ...
                f.prototype.calculateDisplacement = function() {
                  ...
                  for (var g = this.getChild().getNodes(), h, N = 0; N < g.length; N++)
                    h = g[N], h.getChild() == null ? (h.displacementX += a, h.displacementY += l) : h.propogateDisplacementToChildren(a, l);
            ...
            902: (
              ...
              ((o, i2, e2) => {
                function s(g) {
                  if (Array.isArray(g)) {
                    for (var h = 0, N = Array(g.length); h < g.length; h++)
                      N[h] = g[h];
                    return N;
                  } else
                    return Array.from(g);
                ...
                l.handleConstraints = function(g) {
                  var h = {};
                  h.fixedNodeConstraint = g.constraints.fixedNodeConstraint, h.alignmentConstraint = g.constraints.alignmentConstraint, h.relativePlacementConstraint = g.constraints.relativePlacementConstraint;
                  for (var N = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), y = [], A = [], I = g.getAllNodes(), P = 0, Y = 0; Y < I.length; Y++) {
                    var S = I[Y];
                    S.getChild() == null && (c.set(S.id, P++), y.push(S.getCenterX()), A.push(S.getCenterY()), N.set(S.id, S));
                  }
                  ...
                  var H = function(L, R) {
                    ...
                    return L.forEach(function(Q) {
                      R += y[c.get(Q)], V += A[c.get(Q)];
                    }), { x: R / L.size, y: V / L.size };
                  }, x = function(L, R, V, Q, K) {
                    function pt(dt, at) {
                      var st = new Set(dt), It = true, ut = false, Ot = void 0;
                      try {
                    ...
                    var tt = /* @__PURE__ */ new Map(), gt = /* @__PURE__ */ new Map(), rt = new f();
                    lt.forEach(function(dt, at) {
                      dt == 0 ? (rt.push(at), V || (R == "horizontal" ? tt.set(at, c.has(at) ? y[c.get(at)] : Q.get(at)) : tt.set(at, c.has(at) ? A[c.get(at)] : Q.get(at)))) : tt.set(at, Number.NEGATIVE_INFINITY), V && gt.set(at, /* @__PURE__ */ new Set([at]));
                    }), V && K.forEach(function(dt) {
                      var at = [];
                      if (dt.forEach(function(ut) {
                        V.has(ut) && at.push(ut);
                      }), at.length > 0) {
                        var st = 0;
                        at.forEach(function(ut) {
                          R == "horizontal" ? (tt.set(ut, c.has(ut) ? y[c.get(ut)] : Q.get(ut)), st += tt.get(ut)) : (tt.set(ut, c.has(ut) ? A[c.get(ut)] : Q.get(ut)), st += tt.get(ut));
                        }), st = st / at.length, dt.forEach(function(ut) {
                          V.has(ut) || tt.set(ut, st);
                        });
                      } else {
                        var It = 0;
                        dt.forEach(function(ut) {
                          R == "horizontal" ? It += c.has(ut) ? y[c.get(ut)] : Q.get(ut) : It += c.has(ut) ? A[c.get(ut)] : Q.get(ut);
                        }), It = It / dt.length, dt.forEach(function(ut) {
                          tt.set(ut, It);
                        });
                      }
                    });
                    for (var Nt = function() {
                      ...
                      at.forEach(function(st) {
                        if (tt.get(st.id) < tt.get(dt) + st.gap)
                          if (V && V.has(st.id)) {
                            var It = void 0;
                            if (R == "horizontal" ? It = c.has(st.id) ? y[c.get(st.id)] : Q.get(st.id) : It = c.has(st.id) ? A[c.get(st.id)] : Q.get(st.id), tt.set(st.id, It), It < tt.get(dt) + st.gap) {
                              var ut = tt.get(dt) + st.gap - It;
                              gt.get(dt).forEach(function(Ot) {
                                tt.set(Ot, tt.get(Ot) - ut);
                              });
                            }
                          } else
                            tt.set(st.id, tt.get(dt) + st.gap);
                        lt.set(st.id, lt.get(st.id) - 1), lt.get(st.id) == 0 && rt.push(st.id), V && gt.set(st.id, pt(gt.get(dt), gt.get(st.id)));
                      });
                    }; rt.length != 0; )
                      Nt();
                    if (V) {
                      ...
                      var Ct = [];
                      gt.forEach(function(dt, at) {
                        if (yt.has(at)) {
                          var st = false, It = true, ut = false, Ot = void 0;
                          try {
                        ...
                        var st = Number.POSITIVE_INFINITY, It = Number.POSITIVE_INFINITY, ut = Number.NEGATIVE_INFINITY, Ot = Number.NEGATIVE_INFINITY, Ut = true, Lt = false, At = void 0;
                        try {
                          for (var Ht = dt[Symbol.iterator](), Yt; !(Ut = (Yt = Ht.next()).done); Ut = true) {
                            var Rt = Yt.value, kt = void 0;
                            R == "horizontal" ? kt = c.has(Rt) ? y[c.get(Rt)] : Q.get(Rt) : kt = c.has(Rt) ? A[c.get(Rt)] : Q.get(Rt);
                            var Zt = tt.get(Rt);
                        ...
                        var he = (st + ut) / 2 - (It + Ot) / 2, re = true, Qt = false, Jt = void 0;
                        try {
                    ...
                    var R = 0, V = 0, Q = 0, K = 0;
                    if (L.forEach(function(gt) {
                      gt.left ? y[c.get(gt.left)] - y[c.get(gt.right)] >= 0 ? R++ : V++ : A[c.get(gt.top)] - A[c.get(gt.bottom)] >= 0 ? Q++ : K++;
                    }), R > V && Q > K)
                      for (var pt = 0; pt < c.size; pt++)
                        y[pt] = -1 * y[pt], A[pt] = -1 * A[pt];
                    else if (R > V)
                      for (var lt = 0; lt < c.size; lt++)
                        y[lt] = -1 * y[lt];
                    else if (Q > K)
                      for (var tt = 0; tt < c.size; tt++)
                        A[tt] = -1 * A[tt];
                  }, r = function(L) {
                  ...
                  }, v = [], m = [], O = false, M = false, C = /* @__PURE__ */ new Set(), F2 = /* @__PURE__ */ new Map(), U = /* @__PURE__ */ new Map(), z = [];
                  if (h.fixedNodeConstraint && h.fixedNodeConstraint.forEach(function(L) {
                    C.add(L.nodeId);
                  }), h.relativePlacementConstraint && (h.relativePlacementConstraint.forEach(function(L) {
                    L.left ? (F2.has(L.left) ? F2.get(L.left).push({ id: L.right, gap: L.gap, direction: "horizontal" }) : F2.set(L.left, [{ id: L.right, gap: L.gap, direction: "horizontal" }]), F2.has(L.right) || F2.set(L.right, [])) : (F2.has(L.top) ? F2.get(L.top).push({ id: L.bottom, gap: L.gap, direction: "vertical" }) : F2.set(L.top, [{ id: L.bottom, gap: L.gap, direction: "vertical" }]), F2.has(L.bottom) || F2.set(L.bottom, []));
                  }), U = E(F2), z = r(U)), n.TRANSFORM_ON_CONSTRAINT_HANDLING) {
                    if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 1)
                      h.fixedNodeConstraint.forEach(function(L, R) {
                        v[R] = [L.position.x, L.position.y], m[R] = [y[c.get(L.nodeId)], A[c.get(L.nodeId)]];
                      }), O = true;
                      ...
                      (function() {
                        ...
                        if (h.alignmentConstraint.vertical) {
                          for (var R = h.alignmentConstraint.vertical, V = function(tt) {
                            ...
                            var rt = new Set([].concat(s(gt)).filter(function(yt) {
                              return C.has(yt);
                            })), Nt = void 0;
                            rt.size > 0 ? Nt = y[c.get(rt.values().next().value)] : Nt = Z(gt).x, R[tt].forEach(function(yt) {
                              v[L] = [Nt, A[c.get(yt)]], m[L] = [y[c.get(yt)], A[c.get(yt)]], L++;
                            });
                          }, Q = 0; Q < R.length; Q++)
                            V(Q);
                          O = true;
                        ...
                        if (h.alignmentConstraint.horizontal) {
                          for (var K = h.alignmentConstraint.horizontal, pt = function(tt) {
                            ...
                            rt.size > 0 ? Nt = y[c.get(rt.values().next().value)] : Nt = Z(gt).y, K[tt].forEach(function(yt) {
                              v[L] = [y[c.get(yt)], Nt], m[L] = [y[c.get(yt)], A[c.get(yt)]], L++;
                            });
                          }, lt = 0; lt < K.length; lt++)
                            pt(lt);
                          O = true;
                      ...
                      if (W < U.size / 2)
                        ...
                        z[B].forEach(function(L, R) {
                          m[R] = [y[c.get(L)], A[c.get(L)]], v[R] = [], q.has(L) ? v[R][0] = q.get(L) : v[R][0] = y[c.get(L)], et.has(L) ? v[R][1] = et.get(L) : v[R][1] = A[c.get(L)];
                        }), O = true;
                      }
                    }
                    if (O) {
                      ...
                      for (var ht = 0; ht < c.size; ht++) {
                        var _t = [y[ht], A[ht]], Mt = [vt[0][0], vt[1][0]], Tt2 = [vt[0][1], vt[1][1]];
                        y[ht] = t.dotProduct(_t, Mt), A[ht] = t.dotProduct(_t, Tt2);
                      }
                  ...
                  if (n.ENFORCE_CONSTRAINTS) {
                    if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 0) {
                      var wt = { x: 0, y: 0 };
                      h.fixedNodeConstraint.forEach(function(L, R) {
                        var V = { x: y[c.get(L.nodeId)], y: A[c.get(L.nodeId)] }, Q = L.position, K = H(Q, V);
                        wt.x += K.x, wt.y += K.y;
                        ...
                        y[c.get(L.nodeId)] = L.position.x, A[c.get(L.nodeId)] = L.position.y;
                      });
                    }
                    if (h.alignmentConstraint) {
                      if (h.alignmentConstraint.vertical)
                        for (var Wt = h.alignmentConstraint.vertical, bt = function(L) {
                          ...
                          V.size > 0 ? Q = y[c.get(V.values().next().value)] : Q = Z(R).x, R.forEach(function(K) {
                            C.has(K) || (y[c.get(K)] = Q);
                          });
                      ...
                      if (h.alignmentConstraint.horizontal)
                        for (var St = h.alignmentConstraint.horizontal, zt = function(L) {
                          ...
                          V.size > 0 ? Q = A[c.get(V.values().next().value)] : Q = Z(R).y, R.forEach(function(K) {
                            C.has(K) || (A[c.get(K)] = Q);
                          });
                    ...
                    h.relativePlacementConstraint && (function() {
                      ...
                      if (C.forEach(function(ft) {
                        ...
                        if (h.alignmentConstraint.vertical)
                          for (var gt = h.alignmentConstraint.vertical, rt = function(ft) {
                            V.set("dummy" + ft, []), gt[ft].forEach(function(xt) {
                              L.set(xt, "dummy" + ft), V.get("dummy" + ft).push(xt), C.has(xt) && lt.add("dummy" + ft);
                            }), K.set("dummy" + ft, y[c.get(gt[ft][0])]);
                      ...
                      }, ut = true, Ot = false, Ut = void 0;
                      try {
                        for (var Lt = F2.keys()[Symbol.iterator](), At; !(ut = (At = Lt.next()).done); ut = true) {
                          var Ht = At.value;
                          It(Ht);
                        }
                      } catch (ft) {
                      ...
                      var je = function(ft) {
                        Q.get(ft) ? Q.get(ft).forEach(function(xt) {
                          A[c.get(xt)] = te.get(ft);
                        }) : A[c.get(ft)] = te.get(ft);
                      }, ce = true, Le = false, _e = void 0;
                      try {
                        for (var ge = te.keys()[Symbol.iterator](), Me; !(ce = (Me = ge.next()).done); ce = true) {
                          var de = Me.value;
                          je(de);
                        }
                      } catch (ft) {
                  ...
                  for (var jt = 0; jt < I.length; jt++) {
                    var ct = I[jt];
                    ct.getChild() == null && ct.setCenter(y[c.get(ct.id)], A[c.get(ct.id)]);
                  }
                }, o.exports = l;
              })
            ),
        ...
        (() => {
          var k = {
            ...
            548: (
              ...
              ((o, i2, e2) => {
                var s = /* @__PURE__ */ (function() {
                  function t(a, l) {
                    var g = [], h = true, N = false, c = void 0;
                    try {
                      for (var y = a[Symbol.iterator](), A; !(h = (A = y.next()).done) && (g.push(A.value), !(l && g.length === l)); h = true)
                        ;
                    } catch (I) {
                      N = true, c = I;
                    } finally {
                ...
                f.getTopMostNodes = function(t) {
                  ...
                  return g;
                }, f.connectComponents = function(t, a, l, g) {
                  var h = new n(), N = /* @__PURE__ */ new Set(), c = [], y = void 0, A = void 0, I = void 0, P = false, Y = 1, S = [], H = [], Z = function() {
                    var x = t.collection();
                    H.push(x);
                    var ot = l[0], r = t.collection();
                    r.merge(ot).merge(ot.descendants().intersection(a)), c.push(ot), r.forEach(function(v) {
                      ...
                      for (var m = 0; m < v.length; m++) {
                        ...
                        if (y = l.intersection(O.union(O.ancestors())), y != null && !N.has(y[0])) {
                          ...
                          M.forEach(function(C) {
                            h.push(C), N.add(C), x.merge(C), l.has(C) && c.push(C);
                          });
                        }
                      }
                    }; h.length != 0; )
                    ...
                    }), c.length == l.length && (P = true), !P || P && Y > 1) {
                      A = c[0], I = A.connectedEdges().length, c.forEach(function(v) {
                        v.connectedEdges().length < I && (I = v.connectedEdges().length, A = v);
                      }), S.push(A.id());
                      var p = t.collection();
                      p.merge(c[0]), c.forEach(function(v) {
                        p.merge(v);
                      }), c = [], l = l.difference(p), Y++;
                    }
                  };
                  do
                    Z();
                  while (!P);
                  return g && S.length > 0 && g.set("dummy" + (g.size + 1), S), H;
                }, f.relocateComponent = function(t, a, l) {
                  if (!l.fixedNodeConstraint) {
                    var g = Number.POSITIVE_INFINITY, h = Number.NEGATIVE_INFINITY, N = Number.POSITIVE_INFINITY, c = Number.NEGATIVE_INFINITY;
                    if (l.quality == "draft") {
                      ...
                      try {
                        for (var P = a.nodeIndexes[Symbol.iterator](), Y; !(y = (Y = P.next()).done); y = true) {
                          ...
                          if (ot) {
                            ...
                            E < g && (g = E), p > h && (h = p), v < N && (N = v), m > c && (c = m);
                          }
                        }
                      } catch (U) {
                        A = true, I = U;
                      ...
                      Object.keys(a).forEach(function(U) {
                        ...
                        W < g && (g = W), B > h && (h = B), $ < N && (N = $), G > c && (c = G);
                      });
                      var C = t.x - (h + g) / 2, F2 = t.y - (c + N) / 2;
                      Object.keys(a).forEach(function(U) {
                        var z = a[U];
                        z.setCenter(z.getCenterX() + C, z.getCenterY() + F2);
                      });
                    }
                  }
                }, f.calcBoundingBox = function(t, a, l, g) {
                  for (var h = Number.MAX_SAFE_INTEGER, N = Number.MIN_SAFE_INTEGER, c = Number.MAX_SAFE_INTEGER, y = Number.MIN_SAFE_INTEGER, A = void 0, I = void 0, P = void 0, Y = void 0, S = t.descendants().not(":parent"), H = S.length, Z = 0; Z < H; Z++) {
                    var x = S[Z];
                    A = a[g.get(x.id())] - x.width() / 2, I = a[g.get(x.id())] + x.width() / 2, P = l[g.get(x.id())] - x.height() / 2, Y = l[g.get(x.id())] + x.height() / 2, h > A && (h = A), N < I && (N = I), c > P && (c = P), y < Y && (y = Y);
                  }
                  var ot = {};
                  return ot.topLeftX = h, ot.topLeftY = c, ot.width = N - h, ot.height = y - c, ot;
                }, f.calcParentsWithoutChildren = function(t, a) {
                  var l = t.collection();
                  return a.nodes(":parent").forEach(function(g) {
                    var h = false;
            ...
            816: (
              /***/
              ((o, i2, e2) => {
                var s = e2(548), n = e2(140).CoSELayout, f = e2(140).CoSENode, t = e2(140).layoutBase.PointD, a = e2(140).layoutBase.DimensionD, l = e2(140).layoutBase.LayoutConstants, g = e2(140).layoutBase.FDLayoutConstants, h = e2(140).CoSEConstants, N = function(c, y) {
                  var A = c.cy, I = c.eles, P = I.nodes(), Y = I.edges(), S = void 0, H = void 0, Z = void 0, x = {};
                  c.randomize && (S = y.nodeIndexes, H = y.xCoords, Z = y.yCoords);
                  var ot = function(C) {
                    return typeof C == "function";
                  }, r = function(C, F2) {
                    return ot(C) ? C(F2) : C;
                  }, E = s.calcParentsWithoutChildren(A, I), p = function C(F2, U, z, W) {
                    for (var B = U.length, $ = 0; $ < B; $++) {
                      ...
                      if (G.outerWidth() != null && G.outerHeight() != null)
                        if (W.randomize)
                          if (!G.isParent())
                            b = F2.add(new f(z.graphManager, new t(H[S.get(G.id())] - q.w / 2, Z[S.get(G.id())] - q.h / 2), new a(parseFloat(q.w), parseFloat(q.h))));
                          else {
                            var et = s.calcBoundingBox(G, H, Z, S);
                            G.intersection(E).length == 0 ? b = F2.add(new f(z.graphManager, new t(et.topLeftX, et.topLeftY), new a(et.width, et.height))) : b = F2.add(new f(z.graphManager, new t(et.topLeftX, et.topLeftY), new a(parseFloat(q.w), parseFloat(q.h))));
                          }
                        else
                          b = F2.add(new f(z.graphManager, new t(G.position("x") - q.w / 2, G.position("y") - q.h / 2), new a(parseFloat(q.w), parseFloat(q.h))));
                      else
                        b = F2.add(new f(this.graphManager));
                    ...
                    for (var z = 0, W = 0, B = 0; B < U.length; B++) {
                      ...
                      if (G && D && G !== D && G.getEdgesBetween(D).length == 0) {
                        var b = F2.add(C.newEdge(), G, D);
                        b.id = $.id(), b.idealLength = r(c.idealEdgeLength, $), b.edgeElasticity = r(c.edgeElasticity, $), z += b.idealLength, W++;
                      }
                    }
                    c.idealEdgeLength != null && (W > 0 ? h.DEFAULT_EDGE_LENGTH = g.DEFAULT_EDGE_LENGTH = z / W : ot(c.idealEdgeLength) ? h.DEFAULT_EDGE_LENGTH = g.DEFAULT_EDGE_LENGTH = 50 : h.DEFAULT_EDGE_LENGTH = g.DEFAULT_EDGE_LENGTH = c.idealEdgeLength, h.MIN_REPULSION_DIST = g.MIN_REPULSION_DIST = g.DEFAULT_EDGE_LENGTH / 10, h.DEFAULT_RADIAL_SEPARATION = g.DEFAULT_EDGE_LENGTH);
                  }, m = function(C, F2) {
                    F2.fixedNodeConstraint && (C.constraints.fixedNodeConstraint = F2.fixedNodeConstraint), F2.alignmentConstraint && (C.constraints.alignmentConstraint = F2.alignmentConstraint), F2.relativePlacementConstraint && (C.constraints.relativePlacementConstraint = F2.relativePlacementConstraint);
                  };
                  c.nestingFactor != null && (h.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = g.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = c.nestingFactor), c.gravity != null && (h.DEFAULT_GRAVITY_STRENGTH = g.DEFAULT_GRAVITY_STRENGTH = c.gravity), c.numIter != null && (h.MAX_ITERATIONS = g.MAX_ITERATIONS = c.numIter), c.gravityRange != null && (h.DEFAULT_GRAVITY_RANGE_FACTOR = g.DEFAULT_GRAVITY_RANGE_FACTOR = c.gravityRange), c.gravityCompound != null && (h.DEFAULT_COMPOUND_GRAVITY_STRENGTH = g.DEFAULT_COMPOUND_GRAVITY_STRENGTH = c.gravityCompound), c.gravityRangeCompound != null && (h.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = g.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR = c.gravityRangeCompound), c.initialEnergyOnIncremental != null && (h.DEFAULT_COOLING_FACTOR_INCREMENTAL = g.DEFAULT_COOLING_FACTOR_INCREMENTAL = c.initialEnergyOnIncremental), c.tilingCompareBy != null && (h.TILING_COMPARE_BY = c.tilingCompareBy), c.quality == "proof" ? l.QUALITY = 2 : l.QUALITY = 0, h.NODE_DIMENSIONS_INCLUDE_LABELS = g.NODE_DIMENSIONS_INCLUDE_LABELS = l.NODE_DIMENSIONS_INCLUDE_LABELS = c.nodeDimensionsIncludeLabels, h.DEFAULT_INCREMENTAL = g.DEFAULT_INCREMENTAL = l.DEFAULT_INCREMENTAL = !c.randomize, h.ANIMATE = g.ANIMATE = l.ANIMATE = c.animate, h.TILE = c.tile, h.TILING_PADDING_VERTICAL = typeof c.tilingPaddingVertical == "function" ? c.tilingPaddingVertical.call() : c.tilingPaddingVertical, h.TILING_PADDING_HORIZONTAL = typeof c.tilingPaddingHorizontal == "function" ? c.tilingPaddingHorizontal.call() : c.tilingPaddingHorizontal, h.DEFAULT_INCREMENTAL = g.DEFAULT_INCREMENTAL = l.DEFAULT_INCREMENTAL = true, h.PURE_INCREMENTAL = !c.randomize, l.DEFAULT_UNIFORM_LEAF_NODE_SIZES = c.uniformNodeDimensions, c.step == "transformed" && (h.TRANSFORM_ON_CONSTRAINT_HANDLING = true, h.ENFORCE_CONSTRAINTS = false, h.APPLY_LAYOUT = false), c.step == "enforced" && (h.TRANSFORM_ON_CONSTRAINT_HANDLING = false, h.ENFORCE_CONSTRAINTS = true, h.APPLY_LAYOUT = false), c.step == "cose" && (h.TRANSFORM_ON_CONSTRAINT_HANDLING = false, h.ENFORCE_CONSTRAINTS = false, h.APPLY_LAYOUT = true), c.step == "all" && (c.randomize ? h.TRANSFORM_ON_CONSTRAINT_HANDLING = true : h.TRANSFORM_ON_CONSTRAINT_HANDLING = false, h.ENFORCE_CONSTRAINTS = true, h.APPLY_LAYOUT = true), c.fixedNodeConstraint || c.alignmentConstraint || c.relativePlacementConstraint ? h.TREE_REDUCTION_ON_INCREMENTAL = false : h.TREE_REDUCTION_ON_INCREMENTAL = true;
                  var O = new n(), M = O.newGraphManager();
                  return p(M.addRoot(), s.getTopMostNodes(P), O, c), v(O, M, Y), m(O, c), O.runLayout(), x;
                };
            ...
            212: (
              ...
              ((o, i2, e2) => {
                ...
                var f = e2(658), t = e2(548), a = e2(657), l = a.spectralLayout, g = e2(816), h = g.coseLayout, N = Object.freeze({
                    ...
                    value: function() {
                      ...
                      if (P.layoutUtilities && I.packComponents && (r = P.layoutUtilities("get"), r || (r = P.layoutUtilities()), E = true), Y.nodes().length > 0)
                        if (E) {
                          ...
                          if (Z = t.connectComponents(P, I.eles, p), Z.forEach(function(J) {
                            ...
                            var v = P.collection();
                            if (I.tile) {
                              var m = /* @__PURE__ */ new Map(), O = [], M = [], C = 0, F2 = { nodeIndexes: m, xCoords: O, yCoords: M }, U = [];
                              if (Z.forEach(function(J, nt) {
                                J.edges().length == 0 && (J.nodes().forEach(function(mt, ht) {
                                  v.merge(J.nodes()[ht]), mt.isParent() || (F2.nodeIndexes.set(J.nodes()[ht].id(), C++), F2.xCoords.push(J.nodes()[0].position().x), F2.yCoords.push(J.nodes()[0].position().y));
                                }), U.push(nt));
                              }), v.length > 1) {
                                var z = v.boundingBox();
                                x.push({ x: z.x1 + z.w / 2, y: z.y1 + z.h / 2 }), Z.push(v), S.push(F2);
                                ...
                                J.nodes().not(G).forEach(function(Mt) {
                                  if (I.quality == "draft")
                                    if (!Mt.isParent())
                                      ...
                                      var Tt2 = t.calcBoundingBox(Mt, S[nt].xCoords, S[nt].yCoords, mt);
                                      ht.nodes.push({ x: Tt2.topLeftX, y: Tt2.topLeftY, width: Tt2.width, height: Tt2.height });
                                    }
                                  else
                                  ...
                                  var Tt2 = Mt.source(), wt = Mt.target();
                                  if (Tt2.css("display") != "none" && wt.css("display") != "none")
                                    if (I.quality == "draft") {
                                      var Wt = mt.get(Tt2.id()), bt = mt.get(wt.id()), Pt = [], St = [];
                                      if (Tt2.isParent()) {
                                        var zt = t.calcBoundingBox(Tt2, S[nt].xCoords, S[nt].yCoords, mt);
                                      ...
                                      H[nt][Tt2.id()] && H[nt][wt.id()] && ht.edges.push({ startX: H[nt][Tt2.id()].getCenterX(), startY: H[nt][Tt2.id()].getCenterY(), endX: H[nt][wt.id()].getCenterX(), endY: H[nt][wt.id()].getCenterY() });
                      ...
                      var vt = function(J, nt) {
                        if (I.quality == "default" || I.quality == "proof") {
                          ...
                          return H.forEach(function(Tt2) {
                            _t in Tt2 && (mt = { x: Tt2[_t].getRect().getCenterX(), y: Tt2[_t].getRect().getCenterY() }, ht = Tt2[_t]);
                          ...
                          var Mt = void 0;
                          return S.forEach(function(Tt2) {
                            var wt = Tt2.nodeIndexes.get(J.id());
                            wt != null && (Mt = { x: Tt2.xCoords[wt], y: Tt2.yCoords[wt] });
            ...
            657: (
              ...
              ((o, i2, e2) => {
                var s = e2(548), n = e2(140).layoutBase.Matrix, f = e2(140).layoutBase.SVD, t = function(a) {
                  var l = a.cy, g = a.eles, h = g.nodes(), N = g.nodes(":parent"), c = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), A = /* @__PURE__ */ new Map(), I = [], P = [], Y = [], S = [], H = [], Z = [], x = [], ot = [], r = void 0, E = 1e8, p = 1e-9, v = a.piTol, m = a.samplingType, O = a.nodeSeparation, M = void 0, C = function() {
                    for (var ct = 0, L = 0, R = false; L < M; ) {
                      ct = Math.floor(Math.random() * r), R = false;
                      for (var V = 0; V < L; V++)
                        if (S[V] == ct) {
                          R = true;
                          break;
                    ...
                    for (var V = [], Q = 0, K = 0, pt = 0, lt = void 0, tt = [], gt = 0, rt = 1, Nt = 0; Nt < r; Nt++)
                      tt[Nt] = E;
                    for (V[K] = ct, tt[ct] = 0; K >= Q; ) {
                      pt = V[Q++];
                    ...
                    for (var ct = f.svd(x), L = ct.S, R = ct.U, V = ct.V, Q = L[0] * L[0] * L[0], K = [], pt = 0; pt < M; pt++) {
                      K[pt] = [];
                      for (var lt = 0; lt < M; lt++)
                    ...
                    for (var ct = void 0, L = void 0, R = [], V = [], Q = [], K = [], pt = 0; pt < r; pt++)
                      R[pt] = Math.random(), V[pt] = Math.random();
                    R = n.normalize(R), V = n.normalize(V);
                    for (var lt = p, tt = p, gt = void 0; ; ) {
                      for (var rt = 0; rt < r; rt++)
                        Q[rt] = R[rt];
                      if (R = n.multGamma(n.multL(n.multGamma(Q), Z, ot)), ct = n.dotProduct(Q, R), R = n.normalize(R), lt = n.dotProduct(Q, R), gt = Math.abs(lt / tt), gt <= 1 + v && gt >= 1)
                        break;
                      tt = lt;
                    }
                    ...
                    for (tt = p; ; ) {
                      for (var yt = 0; yt < r; yt++)
                        K[yt] = V[yt];
                      if (K = n.minusOp(K, n.multCons(Q, n.dotProduct(Q, K))), V = n.multGamma(n.multL(n.multGamma(K), Z, ot)), L = n.dotProduct(K, V), V = n.normalize(V), lt = n.dotProduct(K, V), gt = Math.abs(lt / tt), gt <= 1 + v && gt >= 1)
                        break;
                      tt = lt;
                    }
                    for (var Ct = 0; Ct < r; Ct++)
                      K[Ct] = V[Ct];
                    P = n.multCons(Q, Math.sqrt(Math.abs(ct))), Y = n.multCons(K, Math.sqrt(Math.abs(L)));
                  };
                  s.connectComponents(l, g, s.getTopMostNodes(h), c), N.forEach(function(ct) {
                    s.connectComponents(l, g, s.getTopMostNodes(ct.descendants().intersection(g)), c);
                  });
                  for (var B = 0, $ = 0; $ < h.length; $++)
                    h[$].isParent() || y.set(h[$].id(), B++);
                  var G = true, D = false, b = void 0;
                  try {
                    for (var q = c.keys()[Symbol.iterator](), et; !(G = (et = q.next()).done); G = true) {
                      var vt = et.value;
                      y.set(vt, B++);
                    }
                  } catch (ct) {
                  ...
                  N.forEach(function(ct) {
                    for (var L = ct.children().intersection(g); L.nodes(":childless").length == 0; )
                      L = L.nodes()[0].children().intersection(g);
                    ...
                    }), A.set(ct.id(), L.nodes(":childless")[R].id());
                  }), h.forEach(function(ct) {
                    var L = void 0;
                    ct.isParent() ? L = y.get(A.get(ct.id())) : L = y.get(ct.id()), ct.neighborhood().nodes().forEach(function(R) {
                      g.intersection(ct.edgesWith(R)).length > 0 && (R.isParent() ? I[L].push(A.get(R.id())) : I[L].push(R.id()));
                    });
                  });
                  var Dt = function(ct) {
                    var L = y.get(ct), R = void 0;
                    c.get(ct).forEach(function(V) {
                      l.getElementById(V).isParent() ? R = A.get(V) : R = V, I[L].push(R), I[y.get(R)].push(ct);
                    });
                  }, J = true, nt = false, mt = void 0;
                  try {
                    for (var ht = c.keys()[Symbol.iterator](), _t; !(J = (_t = ht.next()).done); J = true) {
                      var Mt = _t.value;
                      Dt(Mt);
                    }
                  } catch (ct) {
                  ...
                  if (r > 2) {
                    ...
                    for (var Wt = 0; Wt < M; Wt++)
                      ot[Wt] = [];
                    return a.quality == "draft" || a.step == "all" ? (U(m), z(), W(), Tt2 = { nodeIndexes: y, xCoords: P, yCoords: Y }) : (y.forEach(function(ct, L) {
                      P.push(l.getElementById(L).position("x")), Y.push(l.getElementById(L).position("y"));
                    }), Tt2 = { nodeIndexes: y, xCoords: P, yCoords: Y }), Tt2;
                  } else {
                    ...
                    return Tt2 = { nodeIndexes: y, xCoords: P, yCoords: Y }, Tt2;
                  }
                };
...
var Re = {
  L: F((w) => `${w},${w / 2} 0,${w} 0,0`, "L"),
  R: F((w) => `0,${w / 2} ${w},0 ${w},${w}`, "R"),
  T: F((w) => `0,0 ${w},0 ${w / 2},${w}`, "T"),
  B: F((w) => `${w / 2},0 ${w},${w} 0,${w}`, "B")
};
var ae = {
  L: F((w, X) => w - X + 2, "L"),
  R: F((w, X) => w - 2, "R"),
...
var Te = F(function(w, X) {
  const _ = Xt(w) && qt(X), k = qt(w) && Xt(X);
  return _ || k;
}, "isArchitectureDirectionXY");
var Ai = F(function(w) {
  const X = w[0], _ = w[1], k = Xt(X) && qt(_), T = qt(X) && Xt(_);
  return k || T;
}, "isArchitecturePairXY");
var wi = F(function(w) {
  return w !== "LL" && w !== "RR" && w !== "TT" && w !== "BB";
}, "isValidArchitectureDirectionPair");
var me = F(function(w, X) {
  const _ = `${w}${X}`;
  return wi(_) ? _ : void 0;
}, "getArchitectureDirectionPair");
var Ii = F(function([w, X], _) {
  const k = _[0], T = _[1];
...
var Fe = F((w) => w.data(), "edgeData");
var ie = F((w) => w.data(), "nodeData");
var Se = eW.architecture;
var Et = new e(() => ({
  nodes: {},
  groups: {},
  edges: [],
...
var Oi = F(() => Object.values(Et.records.nodes).filter(Mi), "getServices");
var Ri = F(function({ id: w, in: X }) {
  Et.records.registeredIds[w] = "node", Et.records.nodes[w] = {
    id: w,
    type: "junction",
    edges: [],
...
var bi = F(() => Object.values(Et.records.nodes).filter(xi), "getJunctions");
var Pi = F(() => Object.values(Et.records.nodes), "getNodes");
var ye = F((w) => Et.records.nodes[w], "getNode");
var Gi = F(function({ id: w, icon: X, in: _, title: k }) {
  if (Et.records.registeredIds[w] !== void 0)
    throw new Error(
...
var Fi = F(() => Object.values(Et.records.groups), "getGroups");
var Si = F(function({
  lhsId: w,
  rhsId: X,
  lhsDir: _,
  ...
  if (!be(_))
    throw new Error(
      `Invalid direction given for left hand side of edge ${w}--${X}. Expected (L,R,T,B) got ${_}`
    );
  if (!be(k))
    throw new Error(
...
var ki = F(() => {
  if (Et.records.dataStructures === void 0) {
    const w = {}, X = Object.entries(Et.records.nodes).reduce((o, [i2, e2]) => (o[i2] = e2.edges.reduce((s, n) => {
      ...
      return s;
    }, {}), o), {}), _ = Object.keys(X)[0], k = { [_]: 1 }, T = Object.keys(X).reduce(
      (o, i2) => i2 === _ ? o : { ...o, [i2]: 1 },
      {}
    ), u = F((o) => {
      const i2 = { [o]: [0, 0] }, e2 = [o];
...
var Xi = F((w) => Et.records.elements[w], "getElementById");
var Ue = F(() => fC({
  ...Se,
  ...ji().architecture
}), "getConfig");
...
F(Ft, "getConfigField");
var Hi = F((w, X) => {
  i(w, X), w.groups.map(X.addGroup), w.services.map((_) => X.addService({ ..._, type: "service" })), w.junctions.map((_) => X.addJunction({ ..._, type: "junction" })), w.edges.map(X.addEdge);
}, "populateDb");
var Bi = {
  parse: F(async (w) => {
...
`, "getStyles");
var zi = Wi;
var ee = F((w) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${w}</g>`, "wrapIcon");
var ne = {
...
var Vi = F(async function(w, X) {
  const _ = Ft("padding"), k = Ft("iconSize"), T = k / 2, u = k / 6, d = u / 2;
  await Promise.all(
    X.edges().map(async (o) => {
      const {
        source: i2,
      ...
      const { x: c, y } = o[0].midpoint();
      let { x: A, y: I } = o[0].targetEndpoint();
      const P = _ + 4;
      if (n && (Xt(e2) ? h += e2 === "L" ? -P : P : N += e2 === "T" ? -P : P + 18), l && (Xt(t) ? A += t === "L" ? -P : P : I += t === "T" ? -P : P + 18), !n && se.getNode(i2)?.type === "junction" && (Xt(e2) ? h += e2 === "L" ? T : -T : N += e2 === "T" ? T : -T), !l && se.getNode(f)?.type === "junction" && (Xt(t) ? A += t === "L" ? T : -T : I += t === "T" ? T : -T), o[0]._private.rscratch) {
        const Y = w.insert("g");
        if (Y.insert("path").attr("d", `M ${h},${N} L ${c},${y} L${A},${I} `).attr("class", "edge"), s) {
          const S = Xt(e2) ? ae[e2](h, u) : h - d, H = qt(e2) ? ae[e2](N, u) : N - d;
          Y.insert("polygon").attr("points", Re[e2](u)).attr("transform", `translate(${S},${H})`).attr("class", "arrow");
        }
        if (a) {
          const S = Xt(t) ? ae[t](A, u) : A - d, H = qt(t) ? ae[t](I, u) : I - d;
        ...
        if (g) {
          ...
          if (await hl(
            ...
            Z.attr("transform", "translate(" + c + ", " + y + ")");
          else if (S === "Y")
            Z.attr("transform", "translate(" + c + ", " + y + ") rotate(-90)");
          else if (S === "XY") {
            const x = me(e2, t);
            if (x && Ai(x)) {
...
var ji2 = F(async function(w, X) {
  const _ = Ft("padding") * 0.75, k = Ft("fontSize"), T = Ft("iconSize") / 2;
  await Promise.all(
    X.nodes().map(async (u) => {
      const d = ie(u);
      if (d.type === "group") {
        ...
        if (d.icon) {
          const a = n.append("g");
          a.html(
            `<g>${await xf(d.icon, { height: _, width: _, fallbackPrefix: ne.prefix })}</g>`
          ), a.attr(
            "transform",
...
var qi = F(async function(w, X, _) {
  for (const k of _) {
    ...
    if (k.icon)
      d.html(
        `<g>${await xf(k.icon, { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`
      );
    else if (k.iconText) {
      d.html(
        `<g>${await xf("blank", { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`
      );
...
function Xe(w, X) {
  X.nodes().map((_) => {
    const k = ie(_);
    k.type !== "group" && (k.x = _.position().x, k.y = _.position().y, w.getElementById(k.id).attr("transform", "translate(" + (k.x || 0) + "," + (k.y || 0) + ")"));
  });
}
F(Xe, "positionNodes");
function He(w, X) {
...
function Be(w, X) {
  w.forEach((_) => {
    const { lhsId: k, rhsId: T, lhsInto: u, lhsGroup: d, rhsInto: o, lhsDir: i2, rhsDir: e2, rhsGroup: s, title: n } = _, f = Te(_.lhsDir, _.rhsDir) ? "segments" : "straight", t = {
      id: `${k}-${T}`,
      label: n,
      source: k,
      sourceDir: i2,
...
F(Be, "addEdges");
function We(w, X, _) {
  const k = F((o, i2) => Object.entries(o).reduce(
    (e2, [s, n]) => {
      let f = 0;
    ...
    return Object.entries(o).forEach(([s, [n, f]]) => {
      const t = w.getNode(s)?.in ?? "default";
      i2[f] ??= {}, i2[f][t] ??= [], i2[f][t].push(s), e2[n] ??= {}, e2[n][t] ??= [], e2[n][t].push(s);
    }), {
...
F(We, "getAlignments");
function ze(w) {
  const X = [], _ = F((T) => `${T[0]},${T[1]}`, "posToStr"), k = F((T) => T.split(",").map((u) => parseInt(u)), "strToPos");
  return w.forEach((T) => {
    const u = Object.fromEntries(
      Object.entries(T).map(([e2, s]) => [_(s), e2])
    ), d = [_([0, 0])], o = {}, i2 = {
      L: [-1, 0],
      R: [1, 0],
      T: [0, 1],
      ...
      if (e2) {
        ...
        if (s) {
          ...
          Object.entries(i2).forEach(([f, t]) => {
            const a = _([n[0] + t[0], n[1] + t[1]]), l = u[a];
...
F(ze, "getRelativeConstraints");
function Ve(w, X, _, k, T, { spatialMaps: u, groupAlignments: d }) {
  return new Promise((o) => {
    const i2 = gn("body").append("div").attr("id", "cy").attr("style", "display:none"), e2 = Jn({
    ...
    i2.remove(), He(_, e2), ke(w, e2), Ye(X, e2), Be(k, e2);
    const s = We(T, u, d), n = ze(u), f = e2.layout({
      ...
      idealEdgeLength(t) {
        const [a, l] = t.connectedNodes(), { parent: g } = ie(a), { parent: h } = ie(l);
        return g === h ? 1.5 * Ft("iconSize") : 0.5 * Ft("iconSize");
      },
      edgeElasticity(t) {
        const [a, l] = t.connectedNodes(), { parent: g } = ie(a), { parent: h } = ie(l);
        return g === h ? 0.45 : 1e-3;
      },
    ...
    f.one("layoutstop", () => {
      function t(a, l, g, h) {
        ...
        c = (h - A + (y - g) * (A - P) / (y - I)) / Math.sqrt(1 + Math.pow((A - P) / (y - I), 2)), N = Math.sqrt(Math.pow(h - A, 2) + Math.pow(g - y, 2) - Math.pow(c, 2));
        const Y = Math.sqrt(Math.pow(I - y, 2) + Math.pow(P - A, 2));
        N = N / Y;
        let S = (I - y) * (h - A) - (P - A) * (g - y);
        switch (true) {
          case S >= 0:
            S = 1;
            break;
        ...
        return c = Math.abs(c) * S, N = N * H, {
          distances: c,
          weights: N
        };
      }
      F(t, "getSegmentWeights"), e2.startBatch();
      for (const a of Object.values(e2.edges()))
        if (a.data?.()) {
          const { x: l, y: g } = a.source().position(), { x: h, y: N } = a.target().position();
          if (l !== h && g !== N) {
            const c = a.sourceEndpoint(), y = a.targetEndpoint(), { sourceDir: A } = Fe(a), [I, P] = qt(A) ? [c.x, y.y] : [y.x, c.y], { weights: Y, distances: S } = t(c, y, I, P);
            a.style("segment-distances", S), a.style("segment-weights", Y);
          }
        }
      e2.endBatch(), f.run();
    }), f.run(), e2.ready((t) => {
      Tt.info("Ready", t), o(e2);
    });
  });
}
F(Ve, "layoutArchitecture");
var Ki = F(async (w, X, _, k) => {
  const T = k.db, u = T.getServices(), d = T.getJunctions(), o = T.getGroups(), i2 = T.getEdges(), e2 = T.getDataStructures(), s = p9t(X), n = s.append("g");
  ...
  await Vi(n, a), await ji2(t, a), Xe(T, a), X2t(void 0, s, Ft("padding"), Ft("useMaxWidth"));
}, "draw");
var Zi = { draw: Ki };
var rr = {
  parser: Bi,
...
//# sourceMappingURL=architectureDiagram-SUXI7LT5-MkMpV-jr-C80n97YT-G5POSWPE.js.map
